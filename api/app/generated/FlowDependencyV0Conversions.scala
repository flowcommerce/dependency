 ...
 * apibuilder 0.14.96 app.apibuilder.io/flow/dependency/latest/anorm_2_8_parsers
 */
package io.flow.dependency.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqDependencyProjectDependencyResolution: Column[Seq[_root_.io.flow.dependency.v0.models.ProjectDependencyResolution]] = Util.parser { _.as[Seq[_root_.io.flow.dependency.v0.models.ProjectDependencyResolution]] }
    implicit val columnToMapDependencyProjectDependencyResolution: Column[Map[String, _root_.io.flow.dependency.v0.models.ProjectDependencyResolution]] = Util.parser { _.as[Map[String, _root_.io.flow.dependency.v0.models.ProjectDependencyResolution]] }
    implicit val columnToSeqDependencyProjectDependencyResolutionResolved: Column[Seq[_root_.io.flow.dependency.v0.models.ProjectDependencyResolutionResolved]] = Util.parser { _.as[Seq[_root_.io.flow.dependency.v0.models.ProjectDependencyResolutionResolved]] }
    implicit val columnToMapDependencyProjectDependencyResolutionResolved: Column[Map[String, _root_.io.flow.dependency.v0.models.ProjectDependencyResolutionResolved]] = Util.parser { _.as[Map[String, _root_.io.flow.dependency.v0.models.ProjectDependencyResolutionResolved]] }
    ...
    implicit val columnToSeqDependencyProjectUnresolvedSummary: Column[Seq[_root_.io.flow.dependency.v0.models.ProjectUnresolvedSummary]] = Util.parser { _.as[Seq[_root_.io.flow.dependency.v0.models.ProjectUnresolvedSummary]] }
    implicit val columnToMapDependencyProjectUnresolvedSummary: Column[Map[String, _root_.io.flow.dependency.v0.models.ProjectUnresolvedSummary]] = Util.parser { _.as[Map[String, _root_.io.flow.dependency.v0.models.ProjectUnresolvedSummary]] }
    ...
    implicit val columnToSeqDependencyTaskDataSyncLibrariesByPrefix: Column[Seq[_root_.io.flow.dependency.v0.models.TaskDataSyncLibrariesByPrefix]] = Util.parser { _.as[Seq[_root_.io.flow.dependency.v0.models.TaskDataSyncLibrariesByPrefix]] }
    implicit val columnToMapDependencyTaskDataSyncLibrariesByPrefix: Column[Map[String, _root_.io.flow.dependency.v0.models.TaskDataSyncLibrariesByPrefix]] = Util.parser { _.as[Map[String, _root_.io.flow.dependency.v0.models.TaskDataSyncLibrariesByPrefix]] }
    ...
    implicit val columnToSeqDependencyTaskDataSyncOrganizationLibraries: Column[Seq[_root_.io.flow.dependency.v0.models.TaskDataSyncOrganizationLibraries]] = Util.parser { _.as[Seq[_root_.io.flow.dependency.v0.models.TaskDataSyncOrganizationLibraries]] }
    implicit val columnToMapDependencyTaskDataSyncOrganizationLibraries: Column[Map[String, _root_.io.flow.dependency.v0.models.TaskDataSyncOrganizationLibraries]] = Util.parser { _.as[Map[String, _root_.io.flow.dependency.v0.models.TaskDataSyncOrganizationLibraries]] }
