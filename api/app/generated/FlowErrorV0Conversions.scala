 ...
 * apibuilder 0.15.33 app.apibuilder.io/flow/error/latest/anorm_2_8_parsers
 */
package io.flow.error.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqErrorGenericErrorCode: Column[Seq[_root_.io.flow.error.v0.models.GenericErrorCode]] = Util.parser { _.as[Seq[_root_.io.flow.error.v0.models.GenericErrorCode]] }
    implicit val columnToMapErrorGenericErrorCode: Column[Map[String, _root_.io.flow.error.v0.models.GenericErrorCode]] = Util.parser { _.as[Map[String, _root_.io.flow.error.v0.models.GenericErrorCode]] }
    implicit val columnToSeqErrorGenericError: Column[Seq[_root_.io.flow.error.v0.models.GenericError]] = Util.parser { _.as[Seq[_root_.io.flow.error.v0.models.GenericError]] }
    implicit val columnToMapErrorGenericError: Column[Map[String, _root_.io.flow.error.v0.models.GenericError]] = Util.parser { _.as[Map[String, _root_.io.flow.error.v0.models.GenericError]] }
  }
