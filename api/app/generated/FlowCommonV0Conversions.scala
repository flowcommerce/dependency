...
package io.flow.common.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqCommonVatRegistration: Column[Seq[_root_.io.flow.common.v0.models.VatRegistration]] = Util.parser { _.as[Seq[_root_.io.flow.common.v0.models.VatRegistration]] }
    implicit val columnToMapCommonVatRegistration: Column[Map[String, _root_.io.flow.common.v0.models.VatRegistration]] = Util.parser { _.as[Map[String, _root_.io.flow.common.v0.models.VatRegistration]] }
