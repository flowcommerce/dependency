...
package io.flow.common.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqCommonOrganizationType: Column[Seq[_root_.io.flow.common.v0.models.OrganizationType]] = Util.parser { _.as[Seq[_root_.io.flow.common.v0.models.OrganizationType]] }
    implicit val columnToMapCommonOrganizationType: Column[Map[String, _root_.io.flow.common.v0.models.OrganizationType]] = Util.parser { _.as[Map[String, _root_.io.flow.common.v0.models.OrganizationType]] }
    ...
    implicit val columnToSeqCommonChannelReference: Column[Seq[_root_.io.flow.common.v0.models.ChannelReference]] = Util.parser { _.as[Seq[_root_.io.flow.common.v0.models.ChannelReference]] }
    implicit val columnToMapCommonChannelReference: Column[Map[String, _root_.io.flow.common.v0.models.ChannelReference]] = Util.parser { _.as[Map[String, _root_.io.flow.common.v0.models.ChannelReference]] }
    ...
    implicit val columnToSeqCommonLogoImageSetStatic: Column[Seq[_root_.io.flow.common.v0.models.LogoImageSetStatic]] = Util.parser { _.as[Seq[_root_.io.flow.common.v0.models.LogoImageSetStatic]] }
    implicit val columnToMapCommonLogoImageSetStatic: Column[Map[String, _root_.io.flow.common.v0.models.LogoImageSetStatic]] = Util.parser { _.as[Map[String, _root_.io.flow.common.v0.models.LogoImageSetStatic]] }
    implicit val columnToSeqCommonLogoImageStatic: Column[Seq[_root_.io.flow.common.v0.models.LogoImageStatic]] = Util.parser { _.as[Seq[_root_.io.flow.common.v0.models.LogoImageStatic]] }
    implicit val columnToMapCommonLogoImageStatic: Column[Map[String, _root_.io.flow.common.v0.models.LogoImageStatic]] = Util.parser { _.as[Map[String, _root_.io.flow.common.v0.models.LogoImageStatic]] }
    implicit val columnToSeqCommonLogoImageSvg: Column[Seq[_root_.io.flow.common.v0.models.LogoImageSvg]] = Util.parser { _.as[Seq[_root_.io.flow.common.v0.models.LogoImageSvg]] }
    implicit val columnToMapCommonLogoImageSvg: Column[Map[String, _root_.io.flow.common.v0.models.LogoImageSvg]] = Util.parser { _.as[Map[String, _root_.io.flow.common.v0.models.LogoImageSvg]] }
    ...
    implicit val columnToSeqCommonLogoImage: Column[Seq[_root_.io.flow.common.v0.models.LogoImage]] = Util.parser { _.as[Seq[_root_.io.flow.common.v0.models.LogoImage]] }
    implicit val columnToMapCommonLogoImage: Column[Map[String, _root_.io.flow.common.v0.models.LogoImage]] = Util.parser { _.as[Map[String, _root_.io.flow.common.v0.models.LogoImage]] }
