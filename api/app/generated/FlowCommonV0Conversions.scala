...
package io.flow.common.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqCommonCustomerForm: Column[Seq[_root_.io.flow.common.v0.models.CustomerForm]] = Util.parser { _.as[Seq[_root_.io.flow.common.v0.models.CustomerForm]] }
    implicit val columnToMapCommonCustomerForm: Column[Map[String, _root_.io.flow.common.v0.models.CustomerForm]] = Util.parser { _.as[Map[String, _root_.io.flow.common.v0.models.CustomerForm]] }
