 ...
 * apibuilder 0.15.33 app.apibuilder.io/flow/github/latest/anorm_2_8_parsers
 */
import anorm._
...
package io.flow.github.v0.anorm.parsers {
  ...
  object UserOrg {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.github.v0.models.UserOrg] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(
      login: String = "login",
      prefixOpt: Option[String] = None
    ): RowParser[io.flow.github.v0.models.UserOrg] = {
      SqlParser.str(prefixOpt.getOrElse("") + login) map {
        case login => {
          io.flow.github.v0.models.UserOrg(
            login = login
          )
        }
      }
