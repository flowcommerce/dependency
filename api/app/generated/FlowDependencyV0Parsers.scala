...
package io.flow.dependency.v0.anorm.parsers {
  ...
  object ProjectDependencyResolution {
    ...
    def parser(
      ...
      SqlParser.get[Seq[io.flow.dependency.v0.models.ProjectSummary]](prefixOpt.getOrElse("") + circular) map {
        case resolved ~ circular => {
  ...
  object ProjectDependencyResolutionResolved {
    ...
    def parser(
      ...
      SqlParser.long(prefixOpt.getOrElse("") + position) ~
