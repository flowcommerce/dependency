 ...
 * Service version: 0.6.71
 * apibuilder 0.14.3 app.apibuilder.io/flow/common/0.6.71/anorm_2_6_parsers
 */
import anorm._
...
package io.flow.common.v0.anorm.parsers {
  ...
  object Customer {
    ...
    def parser(
      ...
      io.flow.common.v0.anorm.parsers.BillingAddress.parserWithPrefix(prefixOpt.getOrElse("") + addressPrefix).? map {
        case name ~ number ~ phone ~ email ~ address => {
  ...
  object Organization {
    ...
    def parser(
      ...
      io.flow.common.v0.anorm.parsers.OrganizationDefaults.parserWithPrefix(prefixOpt.getOrElse("") + defaultsPrefix).? map {
        case id ~ name ~ environment ~ parent ~ defaults => {
