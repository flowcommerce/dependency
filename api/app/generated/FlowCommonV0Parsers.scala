 ...
 * apibuilder 0.13.0 app.apibuilder.io/flow/common/0.1.59/anorm_2_6_parsers
 */
import anorm._
...
package io.flow.common.v0.anorm.parsers {
  ...
  object Error {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.common.v0.models.Error] = parser(prefixOpt = Some(s"$prefix$sep"))
  ...
  object Healthcheck {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.common.v0.models.Healthcheck] = parser(prefixOpt = Some(s"$prefix$sep"))
  ...
  object Schedule {
    ...
    def parser(
      ...
      SqlParser.str(prefixOpt.getOrElse("") + cutoff).? map {
