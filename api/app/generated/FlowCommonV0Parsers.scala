 ...
 * Service version: 0.6.48
 * apibuilder 0.14.3 app.apibuilder.io/flow/common/0.6.48/anorm_2_6_parsers
 */
import anorm._
  ...
  object MerchantOfRecordEntity {
    ...
    def parser(
      ...
      SqlParser.str(prefixOpt.getOrElse("") + email).? map {
        case name ~ vat ~ streets ~ city ~ province ~ postal ~ country ~ phone ~ email => {
