 ...
 * apibuilder 0.15.33 app.apibuilder.io/flow/common/latest/anorm_2_8_parsers
 */
import anorm._
...
package io.flow.common.v0.anorm.parsers {
  ...
  object EntityIdentifierType {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.common.v0.models.EntityIdentifierType] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(name: String = "entity_identifier_type", prefixOpt: Option[String] = None): RowParser[io.flow.common.v0.models.EntityIdentifierType] = {
      SqlParser.str(prefixOpt.getOrElse("") + name) map {
        case value => io.flow.common.v0.models.EntityIdentifierType(value)
      }
    }
  ...
  object OrganizationStatus {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.common.v0.models.OrganizationStatus] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(name: String = "organization_status", prefixOpt: Option[String] = None): RowParser[io.flow.common.v0.models.OrganizationStatus] = {
      SqlParser.str(prefixOpt.getOrElse("") + name) map {
        case value => io.flow.common.v0.models.OrganizationStatus(value)
      }
    }
  ...
  object OrganizationType {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.common.v0.models.OrganizationType] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(name: String = "organization_type", prefixOpt: Option[String] = None): RowParser[io.flow.common.v0.models.OrganizationType] = {
      SqlParser.str(prefixOpt.getOrElse("") + name) map {
        case value => io.flow.common.v0.models.OrganizationType(value)
      }
    }
  ...
  object ChannelReference {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.common.v0.models.ChannelReference] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(
      id: String = "id",
      prefixOpt: Option[String] = None
    ): RowParser[io.flow.common.v0.models.ChannelReference] = {
      SqlParser.str(prefixOpt.getOrElse("") + id) map {
        case id => {
          io.flow.common.v0.models.ChannelReference(
            id = id
          )
        }
      }
  ...
  object EntityIdentifier {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.common.v0.models.EntityIdentifier] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(
      name: String = "name",
      number: String = "number",
      issuingCountry: String = "issuing_country",
      prefixOpt: Option[String] = None
    ): RowParser[io.flow.common.v0.models.EntityIdentifier] = {
      io.flow.common.v0.anorm.parsers.EntityIdentifierType.parser(prefixOpt.getOrElse("") + name) ~
      SqlParser.str(prefixOpt.getOrElse("") + number) ~
      SqlParser.str(prefixOpt.getOrElse("") + issuingCountry).? map {
        case name ~ number ~ issuingCountry => {
          io.flow.common.v0.models.EntityIdentifier(
            name = name,
            number = number,
  ...
  object LogoImageSetStatic {

    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.common.v0.models.LogoImageSetStatic] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(
      smallPrefix: String = "small",
      mediumPrefix: String = "medium",
      largePrefix: String = "large",
      prefixOpt: Option[String] = None
    ): RowParser[io.flow.common.v0.models.LogoImageSetStatic] = {
      io.flow.common.v0.anorm.parsers.LogoImageStatic.parserWithPrefix(prefixOpt.getOrElse("") + smallPrefix).? ~
      io.flow.common.v0.anorm.parsers.LogoImageStatic.parserWithPrefix(prefixOpt.getOrElse("") + mediumPrefix) ~
      io.flow.common.v0.anorm.parsers.LogoImageStatic.parserWithPrefix(prefixOpt.getOrElse("") + largePrefix).? map {
  ...
  object LogoImageStatic {

    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.common.v0.models.LogoImageStatic] = parser(prefixOpt = Some(s"$prefix$sep"))
    ...
    def parser(
      ...
      prefixOpt: Option[String] = None
    ): RowParser[io.flow.common.v0.models.LogoImageStatic] = {
      SqlParser.str(prefixOpt.getOrElse("") + url) ~
      SqlParser.int(prefixOpt.getOrElse("") + width) ~
      SqlParser.int(prefixOpt.getOrElse("") + height) map {
        case url ~ width ~ height => {
          io.flow.common.v0.models.LogoImageStatic(
            url = url,
            width = width,
            height = height
          )
  ...
  object LogoImageSvg {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.common.v0.models.LogoImageSvg] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(
      url: String = "url",
      prefixOpt: Option[String] = None
    ): RowParser[io.flow.common.v0.models.LogoImageSvg] = {
  ...
  object MerchantOfRecordEntity {
    ...
    def parser(
      ...
      SqlParser.get[Seq[io.flow.common.v0.models.EntityIdentifier]](prefixOpt.getOrElse("") + identifiers).? ~
      SqlParser.get[Seq[String]](prefixOpt.getOrElse("") + streets) ~
      SqlParser.str(prefixOpt.getOrElse("") + city) ~
      SqlParser.str(prefixOpt.getOrElse("") + province).? ~
      SqlParser.str(prefixOpt.getOrElse("") + postal).? ~
      ...
      SqlParser.str(prefixOpt.getOrElse("") + email).? map {
        case organization ~ name ~ vat ~ identifiers ~ streets ~ city ~ province ~ postal ~ country ~ phone ~ email => {
  ...
  object Organization {
    ...
    def parser(
      ...
      io.flow.common.v0.anorm.parsers.OrganizationStatus.parser(prefixOpt.getOrElse("") + status) ~
      io.flow.common.v0.anorm.parsers.OrganizationType.parser(prefixOpt.getOrElse("") + `type`).? map {
        case id ~ name ~ environment ~ parent ~ defaults ~ createdAt ~ status ~ typeInstance => {
  ...
  object OrganizationSummary {
    ...
    def parser(
      ...
      SqlParser.str(prefixOpt.getOrElse("") + id) ~
      SqlParser.str(prefixOpt.getOrElse("") + name) ~
      io.flow.common.v0.anorm.parsers.Environment.parser(prefixOpt.getOrElse("") + environment) map {
        case id ~ name ~ environment => {
  ...
  object LogoImage {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_") = {
      io.flow.common.v0.anorm.parsers.LogoImageSvg.parser(prefixOpt = Some(s"$prefix$sep")) |
      io.flow.common.v0.anorm.parsers.LogoImageSetStatic.parser(prefixOpt = Some(s"$prefix$sep"))
    }

    def parser() = {
      io.flow.common.v0.anorm.parsers.LogoImageSvg.parser() |
      io.flow.common.v0.anorm.parsers.LogoImageSetStatic.parser()
    }
