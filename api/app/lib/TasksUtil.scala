...
class TasksUtil @Inject() (
  ...
  /** Invokes f, ensuring the task is marked processed once the function returns. Logs any exceptions.
    */
  ...
  /** @param limit
    *   Max # of tasks to process on this iteration
    * @param accepts
    *   Returns true if this task should be processed. False otherwise
    * @return
