...
lazy val api = project
  ...
  .settings(commonSettings: _*)
  .settings(
    javaAgents += "com.datadoghq" % "dd-java-agent" % "1.31.1",
    ...
    libraryDependencies ++= Seq(
      ...
      "io.flow" %% "lib-event-sync-play28" % "0.6.42",
      "io.flow" %% "lib-metrics-play28" % "1.0.81",
      "io.flow" %% "lib-log" % "0.2.14",
      "io.flow" %% "lib-usage-play28" % "0.2.39",
      "io.flow" %% "lib-test-utils-play28" % "0.2.25" % Test,
...
lazy val commonSettings: Seq[Setting[_]] = Seq(
  ...
  name ~= ("dependency-" + _),
  libraryDependencies ++= Seq(
    "io.flow" %% "lib-play-play28" % "0.7.92",
