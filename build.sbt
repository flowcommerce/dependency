...
lazy val api = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.flow" %% "lib-event-sync-play28" % "0.6.6",
      "io.flow" %% "lib-metrics-play28" % "1.0.54",
      "io.flow" %% "lib-log" % "0.1.94",
      "io.flow" %% "lib-usage-play28" % "0.2.18",
      "io.flow" %% "lib-test-utils-play28" % "0.1.99" % Test,
...
lazy val commonSettings: Seq[Setting[_]] = Seq(
  name ~= ("dependency-" + _),
  libraryDependencies ++= Seq(
    "io.flow" %% "lib-play-play28" % "0.7.68",
