...
package io.flow.dependency.v0.models {
   ...
   *
   * @param circular A list of projects that could not be resolved due to circular dependencies
   */
  final case class ProjectDependencyResolution(
    ...
    circular: Seq[io.flow.dependency.v0.models.ProjectSummary]
  )
  ...
  package object json {
    ...
    implicit def jsonReadsDependencyProjectDependencyResolution: play.api.libs.json.Reads[ProjectDependencyResolution] = {
      for {
        ...
        circular <- (__ \ "circular").read[Seq[io.flow.dependency.v0.models.ProjectSummary]]
      } yield ProjectDependencyResolution(resolved, circular)
    }
    ...
    def jsObjectProjectDependencyResolution(obj: io.flow.dependency.v0.models.ProjectDependencyResolution): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "circular" -> play.api.libs.json.Json.toJson(obj.circular)
      )
    }
    ...
    implicit def jsonReadsDependencyProjectDependencyResolutionResolved: play.api.libs.json.Reads[ProjectDependencyResolutionResolved] = {
      for {
        ...
        projects <- (__ \ "projects").read[Seq[io.flow.dependency.v0.models.ProjectSummary]]
      } yield ProjectDependencyResolutionResolved(position, projects)
    }
  ...
  class Client(
    ...
    object ProjectDependencyResolutions extends ProjectDependencyResolutions {
      override def get(
        ...
        _executeRequest("GET", s"/${play.utils.UriEncoding.encodePathSegment(organization, "UTF-8")}/project/dependencies", requestHeaders = requestHeaders).map {
