 ...
 * Service version: 0.6.1-44-g68c3bee-b6605c65-add-sync-by-group-spec
 * apibuilder 0.14.3 app.apibuilder.io/flow/dependency/0.6.1-44-g68c3bee-b6605c65-add-sync-by-group-spec/play_2_6_client
 */
...
package io.flow.dependency.v0.models {
  ...
  package object json {
    ...
    def jsObjectCredentials(obj: io.flow.dependency.v0.models.Credentials): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.dependency.v0.models.UsernamePassword => jsObjectUsernamePassword(x) ++ play.api.libs.json.Json.obj("discriminator" -> "username_password")
        case other => {
    ...
    def jsObjectItemSummary(obj: io.flow.dependency.v0.models.ItemSummary): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.dependency.v0.models.BinarySummary => jsObjectBinarySummary(x) ++ play.api.libs.json.Json.obj("discriminator" -> "binary_summary")
        case x: io.flow.dependency.v0.models.LibrarySummary => jsObjectLibrarySummary(x) ++ play.api.libs.json.Json.obj("discriminator" -> "library_summary")
        case x: io.flow.dependency.v0.models.ProjectSummary => jsObjectProjectSummary(x) ++ play.api.libs.json.Json.obj("discriminator" -> "project_summary")
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
...
package io.flow.dependency.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/flow/dependency/0.6.1-44-g68c3bee-b6605c65-add-sync-by-group-spec/play_2_6_client"
    val Version = "0.6.1-44-g68c3bee-b6605c65-add-sync-by-group-spec"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Syncs extends Syncs {
      ...
      override def postAll(
        ...
        _executeRequest("POST", s"/syncs/all", requestHeaders = requestHeaders).map {
          case r if r.status == 204 => ()
          case r if r.status == 404 => throw io.flow.dependency.v0.errors.UnitResponse(r.status)
      ...
      override def postLibrariesAndGroup(
        groupId: String,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Unit] = {
        val payload = play.api.libs.json.Json.obj(
          "group_id" -> play.api.libs.json.Json.toJson(groupId)
        )

        _executeRequest("POST", s"/syncs/libraries/group", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 204 => ()
          case r if r.status == 404 => throw io.flow.dependency.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.dependency.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 204, 404")
        }
  ...
  trait Syncs {
    ...
    /**
     * Synchronize libraries with given groupId
     */
    def postLibrariesAndGroup(
      groupId: String,
      requestHeaders: Seq[(String, String)] = Nil
    )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Unit]
