 ...
 * User agent: apibuilder app.apibuilder.io/flow/dependency/latest/play_2_8_client
 */
package io.flow.dependency.v0.models {
  ...
  object CredentialsDiscriminator {
    ...
    private val byName: Map[String, CredentialsDiscriminator] = all.map(x => x.toString.toLowerCase -> x).toMap
  ...
  object ItemSummaryDiscriminator {
    ...
    private val byName: Map[String, ItemSummaryDiscriminator] = all.map(x => x.toString.toLowerCase -> x).toMap
  ...
  object TaskDataDiscriminator {
    ...
    case object TaskDataSyncLibrariesByPrefix extends TaskDataDiscriminator { override def toString = "task_data_sync_libraries_by_prefix" }
    ...
    val all: scala.List[TaskDataDiscriminator] = scala.List(TaskDataUpserted, TaskDataSync, TaskDataSyncOne, TaskDataSyncLibrariesByPrefix, TaskDataSyncOrganizationLibraries)

    private val byName: Map[String, TaskDataDiscriminator] = all.map(x => x.toString.toLowerCase -> x).toMap
  ...
  /**
   * Provides an ordered set of projects such that each set of projects is sure to
  ...
  final case class ProjectDependencyResolutionResolved(
    projects: Seq[io.flow.dependency.v0.models.ProjectSummary]
  )
  ...
  final case class ProjectUnresolvedSummary(
    ...
    resolvedLibraries: Seq[String],
    unresolvedLibraries: Seq[String]
  )
  ...
  package object json {
    ...
    implicit def jsonWritesDependencyBinaryType: play.api.libs.json.Writes[BinaryType] = {
      (obj: io.flow.dependency.v0.models.BinaryType) => {
        io.flow.dependency.v0.models.json.jsonWritesDependencyBinaryType(obj)
      }
    }
    ...
    implicit def jsonWritesDependencyPublication: play.api.libs.json.Writes[Publication] = {
      (obj: io.flow.dependency.v0.models.Publication) => {
        io.flow.dependency.v0.models.json.jsonWritesDependencyPublication(obj)
      }
    }
    ...
    implicit def jsonWritesDependencyRecommendationType: play.api.libs.json.Writes[RecommendationType] = {
      (obj: io.flow.dependency.v0.models.RecommendationType) => {
        io.flow.dependency.v0.models.json.jsonWritesDependencyRecommendationType(obj)
      }
    }
    ...
    implicit def jsonWritesDependencyRole: play.api.libs.json.Writes[Role] = {
      (obj: io.flow.dependency.v0.models.Role) => {
        io.flow.dependency.v0.models.json.jsonWritesDependencyRole(obj)
      }
    }
    ...
    implicit def jsonWritesDependencyScms: play.api.libs.json.Writes[Scms] = {
      (obj: io.flow.dependency.v0.models.Scms) => {
        io.flow.dependency.v0.models.json.jsonWritesDependencyScms(obj)
      }
    }
    ...
    implicit def jsonWritesDependencySyncEvent: play.api.libs.json.Writes[SyncEvent] = {
      (obj: io.flow.dependency.v0.models.SyncEvent) => {
        io.flow.dependency.v0.models.json.jsonWritesDependencySyncEvent(obj)
      }
    }
    ...
    implicit def jsonWritesDependencySyncType: play.api.libs.json.Writes[SyncType] = {
      (obj: io.flow.dependency.v0.models.SyncType) => {
        io.flow.dependency.v0.models.json.jsonWritesDependencySyncType(obj)
      }
    }
    ...
    implicit def jsonWritesDependencyVisibility: play.api.libs.json.Writes[Visibility] = {
      (obj: io.flow.dependency.v0.models.Visibility) => {
        io.flow.dependency.v0.models.json.jsonWritesDependencyVisibility(obj)
      }
    }

    implicit def jsonReadsDependencyBinary: play.api.libs.json.Reads[io.flow.dependency.v0.models.Binary] = {
      for {
    ...
    def jsObjectBinary(obj: io.flow.dependency.v0.models.Binary): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "organization" -> io.flow.dependency.v0.models.json.jsObjectOrganizationSummary(obj.organization),
    ...
    implicit def jsonWritesDependencyBinary: play.api.libs.json.Writes[Binary] = {
      (obj: io.flow.dependency.v0.models.Binary) => {
        io.flow.dependency.v0.models.json.jsObjectBinary(obj)
      }
    }

    implicit def jsonReadsDependencyBinaryForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.BinaryForm] = {
      for {
    ...
    implicit def jsonWritesDependencyBinaryForm: play.api.libs.json.Writes[BinaryForm] = {
      (obj: io.flow.dependency.v0.models.BinaryForm) => {
        io.flow.dependency.v0.models.json.jsObjectBinaryForm(obj)
      }
    }

    implicit def jsonReadsDependencyBinarySummary: play.api.libs.json.Reads[io.flow.dependency.v0.models.BinarySummary] = {
      for {
        id <- (__ \ "id").read[String]
        organization <- (__ \ "organization").read[io.flow.dependency.v0.models.OrganizationSummary]
        name <- (__ \ "name").read[io.flow.dependency.v0.models.BinaryType]
    ...
    implicit def jsonWritesDependencyBinarySummary: play.api.libs.json.Writes[BinarySummary] = {
      (obj: io.flow.dependency.v0.models.BinarySummary) => {
        io.flow.dependency.v0.models.json.jsObjectBinarySummary(obj)
      }
    }

    implicit def jsonReadsDependencyBinaryVersion: play.api.libs.json.Reads[io.flow.dependency.v0.models.BinaryVersion] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    def jsObjectBinaryVersion(obj: io.flow.dependency.v0.models.BinaryVersion): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "binary" -> io.flow.dependency.v0.models.json.jsObjectBinary(obj.binary),
    ...
    implicit def jsonWritesDependencyBinaryVersion: play.api.libs.json.Writes[BinaryVersion] = {
      (obj: io.flow.dependency.v0.models.BinaryVersion) => {
        io.flow.dependency.v0.models.json.jsObjectBinaryVersion(obj)
      }
    }

    implicit def jsonReadsDependencyGithubAuthenticationForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.GithubAuthenticationForm] = {
      (__ \ "code").read[String].map { x => GithubAuthenticationForm(code = x) }
    }
    ...
    implicit def jsonWritesDependencyGithubAuthenticationForm: play.api.libs.json.Writes[GithubAuthenticationForm] = {
      (obj: io.flow.dependency.v0.models.GithubAuthenticationForm) => {
        io.flow.dependency.v0.models.json.jsObjectGithubAuthenticationForm(obj)
      }
    }

    implicit def jsonReadsDependencyGithubUser: play.api.libs.json.Reads[io.flow.dependency.v0.models.GithubUser] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    implicit def jsonWritesDependencyGithubUser: play.api.libs.json.Writes[GithubUser] = {
      (obj: io.flow.dependency.v0.models.GithubUser) => {
        io.flow.dependency.v0.models.json.jsObjectGithubUser(obj)
      }
    }

    implicit def jsonReadsDependencyGithubUserForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.GithubUserForm] = {
      for {
    ...
    implicit def jsonWritesDependencyGithubUserForm: play.api.libs.json.Writes[GithubUserForm] = {
      (obj: io.flow.dependency.v0.models.GithubUserForm) => {
        io.flow.dependency.v0.models.json.jsObjectGithubUserForm(obj)
      }
    }

    implicit def jsonReadsDependencyGithubWebhook: play.api.libs.json.Reads[io.flow.dependency.v0.models.GithubWebhook] = {
      (__ \ "id").read[Long].map { x => GithubWebhook(id = x) }
    }
    ...
    implicit def jsonWritesDependencyGithubWebhook: play.api.libs.json.Writes[GithubWebhook] = {
      (obj: io.flow.dependency.v0.models.GithubWebhook) => {
        io.flow.dependency.v0.models.json.jsObjectGithubWebhook(obj)
      }
    }

    implicit def jsonReadsDependencyItem: play.api.libs.json.Reads[io.flow.dependency.v0.models.Item] = {
      for {
        id <- (__ \ "id").read[String]
        organization <- (__ \ "organization").read[io.flow.dependency.v0.models.OrganizationSummary]
    ...
    def jsObjectItem(obj: io.flow.dependency.v0.models.Item): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "summary" -> io.flow.dependency.v0.models.json.jsObjectItemSummary(obj.summary),
    ...
    implicit def jsonWritesDependencyItem: play.api.libs.json.Writes[Item] = {
      (obj: io.flow.dependency.v0.models.Item) => {
        io.flow.dependency.v0.models.json.jsObjectItem(obj)
      }
    }

    implicit def jsonReadsDependencyLibrary: play.api.libs.json.Reads[io.flow.dependency.v0.models.Library] = {
      for {
        id <- (__ \ "id").read[String]
        organization <- (__ \ "organization").read[io.flow.dependency.v0.models.OrganizationSummary]
    ...
    def jsObjectLibrary(obj: io.flow.dependency.v0.models.Library): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "resolver" -> io.flow.dependency.v0.models.json.jsObjectResolverSummary(obj.resolver)
      )
    }

    implicit def jsonWritesDependencyLibrary: play.api.libs.json.Writes[Library] = {
      (obj: io.flow.dependency.v0.models.Library) => {
        io.flow.dependency.v0.models.json.jsObjectLibrary(obj)
      }
    }

    implicit def jsonReadsDependencyLibraryForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.LibraryForm] = {
      for {
        organizationId <- (__ \ "organization_id").read[String]
        groupId <- (__ \ "group_id").read[String]
        artifactId <- (__ \ "artifact_id").read[String]
    ...
    def jsObjectLibraryForm(obj: io.flow.dependency.v0.models.LibraryForm): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("version" -> io.flow.dependency.v0.models.json.jsObjectVersionForm(x))
      })
    }
    ...
    implicit def jsonWritesDependencyLibraryForm: play.api.libs.json.Writes[LibraryForm] = {
      (obj: io.flow.dependency.v0.models.LibraryForm) => {
        io.flow.dependency.v0.models.json.jsObjectLibraryForm(obj)
      }
    }

    implicit def jsonReadsDependencyLibrarySummary: play.api.libs.json.Reads[io.flow.dependency.v0.models.LibrarySummary] = {
      for {
        id <- (__ \ "id").read[String]
        organization <- (__ \ "organization").read[io.flow.dependency.v0.models.OrganizationSummary]
        groupId <- (__ \ "group_id").read[String]
    ...
    implicit def jsonWritesDependencyLibrarySummary: play.api.libs.json.Writes[LibrarySummary] = {
      (obj: io.flow.dependency.v0.models.LibrarySummary) => {
        io.flow.dependency.v0.models.json.jsObjectLibrarySummary(obj)
      }
    }

    implicit def jsonReadsDependencyLibraryVersion: play.api.libs.json.Reads[io.flow.dependency.v0.models.LibraryVersion] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    def jsObjectLibraryVersion(obj: io.flow.dependency.v0.models.LibraryVersion): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "library" -> io.flow.dependency.v0.models.json.jsObjectLibrary(obj.library),
        "version" -> play.api.libs.json.JsString(obj.version)
    ...
    implicit def jsonWritesDependencyLibraryVersion: play.api.libs.json.Writes[LibraryVersion] = {
      (obj: io.flow.dependency.v0.models.LibraryVersion) => {
        io.flow.dependency.v0.models.json.jsObjectLibraryVersion(obj)
      }
    }

    implicit def jsonReadsDependencyMembership: play.api.libs.json.Reads[io.flow.dependency.v0.models.Membership] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    def jsObjectMembership(obj: io.flow.dependency.v0.models.Membership): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "user" -> io.flow.dependency.v0.models.json.jsObjectUserSummary(obj.user),
        "organization" -> io.flow.dependency.v0.models.json.jsObjectOrganizationSummary(obj.organization),
    ...
    implicit def jsonWritesDependencyMembership: play.api.libs.json.Writes[Membership] = {
      (obj: io.flow.dependency.v0.models.Membership) => {
        io.flow.dependency.v0.models.json.jsObjectMembership(obj)
      }
    }

    implicit def jsonReadsDependencyMembershipForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.MembershipForm] = {
      for {
        userId <- (__ \ "user_id").read[String]
    ...
    implicit def jsonWritesDependencyMembershipForm: play.api.libs.json.Writes[MembershipForm] = {
      (obj: io.flow.dependency.v0.models.MembershipForm) => {
        io.flow.dependency.v0.models.json.jsObjectMembershipForm(obj)
      }
    }

    implicit def jsonReadsDependencyOrganization: play.api.libs.json.Reads[io.flow.dependency.v0.models.Organization] = {
      for {
        id <- (__ \ "id").read[String]
        user <- (__ \ "user").read[io.flow.common.v0.models.UserReference]
    ...
    implicit def jsonWritesDependencyOrganization: play.api.libs.json.Writes[Organization] = {
      (obj: io.flow.dependency.v0.models.Organization) => {
        io.flow.dependency.v0.models.json.jsObjectOrganization(obj)
      }
    }

    implicit def jsonReadsDependencyOrganizationForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.OrganizationForm] = {
      (__ \ "key").read[String].map { x => OrganizationForm(key = x) }
    }
    ...
    implicit def jsonWritesDependencyOrganizationForm: play.api.libs.json.Writes[OrganizationForm] = {
      (obj: io.flow.dependency.v0.models.OrganizationForm) => {
        io.flow.dependency.v0.models.json.jsObjectOrganizationForm(obj)
      }
    }

    implicit def jsonReadsDependencyOrganizationSummary: play.api.libs.json.Reads[io.flow.dependency.v0.models.OrganizationSummary] = {
      for {
        id <- (__ \ "id").read[String]
        key <- (__ \ "key").read[String]
    ...
    implicit def jsonWritesDependencyOrganizationSummary: play.api.libs.json.Writes[OrganizationSummary] = {
      (obj: io.flow.dependency.v0.models.OrganizationSummary) => {
        io.flow.dependency.v0.models.json.jsObjectOrganizationSummary(obj)
      }
    }

    implicit def jsonReadsDependencyProject: play.api.libs.json.Reads[io.flow.dependency.v0.models.Project] = {
      for {
        id <- (__ \ "id").read[String]
        organization <- (__ \ "organization").read[io.flow.dependency.v0.models.OrganizationSummary]
        user <- (__ \ "user").read[io.flow.common.v0.models.UserReference]
      ...
      } yield Project(id, organization, user, visibility, scms, name, uri, branch)
    }
    ...
    implicit def jsonWritesDependencyProject: play.api.libs.json.Writes[Project] = {
      (obj: io.flow.dependency.v0.models.Project) => {
        io.flow.dependency.v0.models.json.jsObjectProject(obj)
      }
    }

    implicit def jsonReadsDependencyProjectBinary: play.api.libs.json.Reads[io.flow.dependency.v0.models.ProjectBinary] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    def jsObjectProjectBinary(obj: io.flow.dependency.v0.models.ProjectBinary): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "project" -> io.flow.dependency.v0.models.json.jsObjectProjectDetail(obj.project),
        "name" -> play.api.libs.json.JsString(obj.name),
        "version" -> play.api.libs.json.JsString(obj.version),
        "path" -> play.api.libs.json.JsString(obj.path)
      ) ++ (obj.binary match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("binary" -> io.flow.dependency.v0.models.json.jsObjectReference(x))
      })
    }
    ...
    implicit def jsonWritesDependencyProjectBinary: play.api.libs.json.Writes[ProjectBinary] = {
      (obj: io.flow.dependency.v0.models.ProjectBinary) => {
        io.flow.dependency.v0.models.json.jsObjectProjectBinary(obj)
      }
    }

    implicit def jsonReadsDependencyProjectDependencyResolution: play.api.libs.json.Reads[io.flow.dependency.v0.models.ProjectDependencyResolution] = {
      for {
    ...
    implicit def jsonWritesDependencyProjectDependencyResolution: play.api.libs.json.Writes[ProjectDependencyResolution] = {
      (obj: io.flow.dependency.v0.models.ProjectDependencyResolution) => {
        io.flow.dependency.v0.models.json.jsObjectProjectDependencyResolution(obj)
      }
    }

    implicit def jsonReadsDependencyProjectDependencyResolutionResolved: play.api.libs.json.Reads[io.flow.dependency.v0.models.ProjectDependencyResolutionResolved] = {
      (__ \ "projects").read[Seq[io.flow.dependency.v0.models.ProjectSummary]].map { x => ProjectDependencyResolutionResolved(projects = x) }
    }

    def jsObjectProjectDependencyResolutionResolved(obj: io.flow.dependency.v0.models.ProjectDependencyResolutionResolved): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "projects" -> play.api.libs.json.Json.toJson(obj.projects)
      )
    }
    ...
    implicit def jsonWritesDependencyProjectDependencyResolutionResolved: play.api.libs.json.Writes[ProjectDependencyResolutionResolved] = {
      (obj: io.flow.dependency.v0.models.ProjectDependencyResolutionResolved) => {
        io.flow.dependency.v0.models.json.jsObjectProjectDependencyResolutionResolved(obj)
      }
    }

    implicit def jsonReadsDependencyProjectDetail: play.api.libs.json.Reads[io.flow.dependency.v0.models.ProjectDetail] = {
      for {
        id <- (__ \ "id").read[String]
        organization <- (__ \ "organization").read[io.flow.dependency.v0.models.OrganizationSummary]
        name <- (__ \ "name").read[String]
    ...
    implicit def jsonWritesDependencyProjectDetail: play.api.libs.json.Writes[ProjectDetail] = {
      (obj: io.flow.dependency.v0.models.ProjectDetail) => {
        io.flow.dependency.v0.models.json.jsObjectProjectDetail(obj)
      }
    }

    implicit def jsonReadsDependencyProjectForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.ProjectForm] = {
      for {
        organization <- (__ \ "organization").read[String]
        name <- (__ \ "name").read[String]
        visibility <- (__ \ "visibility").read[io.flow.dependency.v0.models.Visibility]
    ...
    implicit def jsonWritesDependencyProjectForm: play.api.libs.json.Writes[ProjectForm] = {
      (obj: io.flow.dependency.v0.models.ProjectForm) => {
        io.flow.dependency.v0.models.json.jsObjectProjectForm(obj)
      }
    }

    implicit def jsonReadsDependencyProjectLibrary: play.api.libs.json.Reads[io.flow.dependency.v0.models.ProjectLibrary] = {
      for {
        id <- (__ \ "id").read[String]
        project <- (__ \ "project").read[io.flow.dependency.v0.models.ProjectDetail]
        groupId <- (__ \ "group_id").read[String]
    ...
    def jsObjectProjectLibrary(obj: io.flow.dependency.v0.models.ProjectLibrary): play.api.libs.json.JsObject = {
      ...
      (obj.library match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("library" -> io.flow.dependency.v0.models.json.jsObjectReference(x))
      })
    }
    ...
    implicit def jsonWritesDependencyProjectLibrary: play.api.libs.json.Writes[ProjectLibrary] = {
      (obj: io.flow.dependency.v0.models.ProjectLibrary) => {
        io.flow.dependency.v0.models.json.jsObjectProjectLibrary(obj)
      }
    }

    implicit def jsonReadsDependencyProjectPatchForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.ProjectPatchForm] = {
      for {
      ...
      } yield ProjectPatchForm(name, visibility, scms, uri, branch)
    }
    ...
    implicit def jsonWritesDependencyProjectPatchForm: play.api.libs.json.Writes[ProjectPatchForm] = {
      (obj: io.flow.dependency.v0.models.ProjectPatchForm) => {
        io.flow.dependency.v0.models.json.jsObjectProjectPatchForm(obj)
      }
    }

    implicit def jsonReadsDependencyProjectSummary: play.api.libs.json.Reads[io.flow.dependency.v0.models.ProjectSummary] = {
      for {
        id <- (__ \ "id").read[String]
        organization <- (__ \ "organization").read[io.flow.dependency.v0.models.OrganizationSummary]
        name <- (__ \ "name").read[String]
    ...
    implicit def jsonWritesDependencyProjectSummary: play.api.libs.json.Writes[ProjectSummary] = {
      (obj: io.flow.dependency.v0.models.ProjectSummary) => {
        io.flow.dependency.v0.models.json.jsObjectProjectSummary(obj)
      }
    }

    implicit def jsonReadsDependencyProjectUnresolvedSummary: play.api.libs.json.Reads[io.flow.dependency.v0.models.ProjectUnresolvedSummary] = {
      for {
        project <- (__ \ "project").read[io.flow.dependency.v0.models.ProjectSummary]
        resolvedLibraries <- (__ \ "resolved_libraries").read[Seq[String]]
        unresolvedLibraries <- (__ \ "unresolved_libraries").read[Seq[String]]
      } yield ProjectUnresolvedSummary(project, resolvedLibraries, unresolvedLibraries)
    }

    def jsObjectProjectUnresolvedSummary(obj: io.flow.dependency.v0.models.ProjectUnresolvedSummary): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "project" -> io.flow.dependency.v0.models.json.jsObjectProjectSummary(obj.project),
        "resolved_libraries" -> play.api.libs.json.Json.toJson(obj.resolvedLibraries),
        "unresolved_libraries" -> play.api.libs.json.Json.toJson(obj.unresolvedLibraries)
      )
    }
    ...
    implicit def jsonWritesDependencyProjectUnresolvedSummary: play.api.libs.json.Writes[ProjectUnresolvedSummary] = {
      (obj: io.flow.dependency.v0.models.ProjectUnresolvedSummary) => {
        io.flow.dependency.v0.models.json.jsObjectProjectUnresolvedSummary(obj)
      }
    }

    implicit def jsonReadsDependencyRecommendation: play.api.libs.json.Reads[io.flow.dependency.v0.models.Recommendation] = {
      for {
        id <- (__ \ "id").read[String]
        project <- (__ \ "project").read[io.flow.dependency.v0.models.ProjectDetail]
    ...
    def jsObjectRecommendation(obj: io.flow.dependency.v0.models.Recommendation): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "object" -> io.flow.dependency.v0.models.json.jsObjectReference(obj.`object`),
        "name" -> play.api.libs.json.JsString(obj.name),
    ...
    implicit def jsonWritesDependencyRecommendation: play.api.libs.json.Writes[Recommendation] = {
      (obj: io.flow.dependency.v0.models.Recommendation) => {
        io.flow.dependency.v0.models.json.jsObjectRecommendation(obj)
      }
    }

    implicit def jsonReadsDependencyReference: play.api.libs.json.Reads[io.flow.dependency.v0.models.Reference] = {
      (__ \ "id").read[String].map { x => Reference(id = x) }
    }
    ...
    implicit def jsonWritesDependencyReference: play.api.libs.json.Writes[Reference] = {
      (obj: io.flow.dependency.v0.models.Reference) => {
        io.flow.dependency.v0.models.json.jsObjectReference(obj)
      }
    }

    implicit def jsonReadsDependencyRepository: play.api.libs.json.Reads[io.flow.dependency.v0.models.Repository] = {
      for {
        name <- (__ \ "name").read[String]
        visibility <- (__ \ "visibility").read[io.flow.dependency.v0.models.Visibility]
        uri <- (__ \ "uri").read[String]
    ...
    implicit def jsonWritesDependencyRepository: play.api.libs.json.Writes[Repository] = {
      (obj: io.flow.dependency.v0.models.Repository) => {
        io.flow.dependency.v0.models.json.jsObjectRepository(obj)
      }
    }

    implicit def jsonReadsDependencyResolver: play.api.libs.json.Reads[io.flow.dependency.v0.models.Resolver] = {
      for {
        id <- (__ \ "id").read[String]
        visibility <- (__ \ "visibility").read[io.flow.dependency.v0.models.Visibility]
    ...
    def jsObjectResolver(obj: io.flow.dependency.v0.models.Resolver): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("organization" -> io.flow.dependency.v0.models.json.jsObjectOrganizationSummary(x))
      }) ++
      (obj.credentials match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("credentials" -> io.flow.dependency.v0.models.json.jsObjectCredentials(x))
      })
    }

    implicit def jsonWritesDependencyResolver: play.api.libs.json.Writes[Resolver] = {
      (obj: io.flow.dependency.v0.models.Resolver) => {
        io.flow.dependency.v0.models.json.jsObjectResolver(obj)
      }
    }

    implicit def jsonReadsDependencyResolverForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.ResolverForm] = {
      for {
        visibility <- (__ \ "visibility").read[io.flow.dependency.v0.models.Visibility]
        organization <- (__ \ "organization").read[String]
        uri <- (__ \ "uri").read[String]
    ...
    implicit def jsonWritesDependencyResolverForm: play.api.libs.json.Writes[ResolverForm] = {
      (obj: io.flow.dependency.v0.models.ResolverForm) => {
        io.flow.dependency.v0.models.json.jsObjectResolverForm(obj)
      }
    }

    implicit def jsonReadsDependencyResolverSummary: play.api.libs.json.Reads[io.flow.dependency.v0.models.ResolverSummary] = {
      for {
        id <- (__ \ "id").read[String]
        organization <- (__ \ "organization").readNullable[io.flow.dependency.v0.models.OrganizationSummary]
        visibility <- (__ \ "visibility").read[io.flow.dependency.v0.models.Visibility]
    ...
    implicit def jsonWritesDependencyResolverSummary: play.api.libs.json.Writes[ResolverSummary] = {
      (obj: io.flow.dependency.v0.models.ResolverSummary) => {
        io.flow.dependency.v0.models.json.jsObjectResolverSummary(obj)
      }
    }

    implicit def jsonReadsDependencySubscription: play.api.libs.json.Reads[io.flow.dependency.v0.models.Subscription] = {
      for {
        id <- (__ \ "id").read[String]
        user <- (__ \ "user").read[io.flow.common.v0.models.UserReference]
    ...
    implicit def jsonWritesDependencySubscription: play.api.libs.json.Writes[Subscription] = {
      (obj: io.flow.dependency.v0.models.Subscription) => {
        io.flow.dependency.v0.models.json.jsObjectSubscription(obj)
      }
    }

    implicit def jsonReadsDependencySubscriptionForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.SubscriptionForm] = {
      for {
        userId <- (__ \ "user_id").read[String]
        publication <- (__ \ "publication").read[io.flow.dependency.v0.models.Publication]
    ...
    implicit def jsonWritesDependencySubscriptionForm: play.api.libs.json.Writes[SubscriptionForm] = {
      (obj: io.flow.dependency.v0.models.SubscriptionForm) => {
        io.flow.dependency.v0.models.json.jsObjectSubscriptionForm(obj)
      }
    }

    implicit def jsonReadsDependencySync: play.api.libs.json.Reads[io.flow.dependency.v0.models.Sync] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    implicit def jsonWritesDependencySync: play.api.libs.json.Writes[Sync] = {
      (obj: io.flow.dependency.v0.models.Sync) => {
        io.flow.dependency.v0.models.json.jsObjectSync(obj)
      }
    }

    implicit def jsonReadsDependencyTaskDataSync: play.api.libs.json.Reads[io.flow.dependency.v0.models.TaskDataSync] = {
      (__ \ "type").readNullable[io.flow.dependency.v0.models.SyncType].map { x => TaskDataSync(`type` = x) }
    }
    ...
    implicit def jsonWritesDependencyTaskDataSync: play.api.libs.json.Writes[TaskDataSync] = {
      (obj: io.flow.dependency.v0.models.TaskDataSync) => {
        io.flow.dependency.v0.models.json.jsObjectTaskDataSync(obj)
      }
    }

    implicit def jsonReadsDependencyTaskDataSyncLibrariesByPrefix: play.api.libs.json.Reads[io.flow.dependency.v0.models.TaskDataSyncLibrariesByPrefix] = {
      for {
        userId <- (__ \ "user_id").read[String]
        prefix <- (__ \ "prefix").read[String]
      } yield TaskDataSyncLibrariesByPrefix(userId, prefix)
    }

    def jsObjectTaskDataSyncLibrariesByPrefix(obj: io.flow.dependency.v0.models.TaskDataSyncLibrariesByPrefix): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "user_id" -> play.api.libs.json.JsString(obj.userId),
        "prefix" -> play.api.libs.json.JsString(obj.prefix)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "task_data_sync_libraries_by_prefix")
    }
    ...
    implicit def jsonWritesDependencyTaskDataSyncLibrariesByPrefix: play.api.libs.json.Writes[TaskDataSyncLibrariesByPrefix] = {
      (obj: io.flow.dependency.v0.models.TaskDataSyncLibrariesByPrefix) => {
        io.flow.dependency.v0.models.json.jsObjectTaskDataSyncLibrariesByPrefix(obj)
      }
    }

    implicit def jsonReadsDependencyTaskDataSyncOne: play.api.libs.json.Reads[io.flow.dependency.v0.models.TaskDataSyncOne] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    implicit def jsonWritesDependencyTaskDataSyncOne: play.api.libs.json.Writes[TaskDataSyncOne] = {
      (obj: io.flow.dependency.v0.models.TaskDataSyncOne) => {
        io.flow.dependency.v0.models.json.jsObjectTaskDataSyncOne(obj)
      }
    }

    implicit def jsonReadsDependencyTaskDataSyncOrganizationLibraries: play.api.libs.json.Reads[io.flow.dependency.v0.models.TaskDataSyncOrganizationLibraries] = {
      (__ \ "organization_id").read[String].map { x => TaskDataSyncOrganizationLibraries(organizationId = x) }
    }
    ...
    implicit def jsonWritesDependencyTaskDataSyncOrganizationLibraries: play.api.libs.json.Writes[TaskDataSyncOrganizationLibraries] = {
      (obj: io.flow.dependency.v0.models.TaskDataSyncOrganizationLibraries) => {
        io.flow.dependency.v0.models.json.jsObjectTaskDataSyncOrganizationLibraries(obj)
      }
    }

    implicit def jsonReadsDependencyTaskDataUpserted: play.api.libs.json.Reads[io.flow.dependency.v0.models.TaskDataUpserted] = {
      for {
        id <- (__ \ "id").read[String]
        `type` <- (__ \ "type").read[io.flow.dependency.v0.models.SyncType]
    ...
    implicit def jsonWritesDependencyTaskDataUpserted: play.api.libs.json.Writes[TaskDataUpserted] = {
      (obj: io.flow.dependency.v0.models.TaskDataUpserted) => {
        io.flow.dependency.v0.models.json.jsObjectTaskDataUpserted(obj)
      }
    }

    implicit def jsonReadsDependencyToken: play.api.libs.json.Reads[io.flow.dependency.v0.models.Token] = {
      for {
        id <- (__ \ "id").read[String]
        user <- (__ \ "user").read[io.flow.common.v0.models.UserReference]
    ...
    implicit def jsonWritesDependencyToken: play.api.libs.json.Writes[Token] = {
      (obj: io.flow.dependency.v0.models.Token) => {
        io.flow.dependency.v0.models.json.jsObjectToken(obj)
      }
    }

    implicit def jsonReadsDependencyTokenForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.TokenForm] = {
      for {
        userId <- (__ \ "user_id").read[String]
        description <- (__ \ "description").readNullable[String]
    ...
    implicit def jsonWritesDependencyTokenForm: play.api.libs.json.Writes[TokenForm] = {
      (obj: io.flow.dependency.v0.models.TokenForm) => {
        io.flow.dependency.v0.models.json.jsObjectTokenForm(obj)
      }
    }

    implicit def jsonReadsDependencyUserForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.UserForm] = {
      for {
    ...
    implicit def jsonWritesDependencyUserForm: play.api.libs.json.Writes[UserForm] = {
      (obj: io.flow.dependency.v0.models.UserForm) => {
        io.flow.dependency.v0.models.json.jsObjectUserForm(obj)
      }
    }

    implicit def jsonReadsDependencyUserIdentifier: play.api.libs.json.Reads[io.flow.dependency.v0.models.UserIdentifier] = {
      for {
        id <- (__ \ "id").read[String]
        user <- (__ \ "user").read[io.flow.common.v0.models.UserReference]
    ...
    implicit def jsonWritesDependencyUserIdentifier: play.api.libs.json.Writes[UserIdentifier] = {
      (obj: io.flow.dependency.v0.models.UserIdentifier) => {
        io.flow.dependency.v0.models.json.jsObjectUserIdentifier(obj)
      }
    }

    implicit def jsonReadsDependencyUserSummary: play.api.libs.json.Reads[io.flow.dependency.v0.models.UserSummary] = {
      for {
        id <- (__ \ "id").read[String]
        email <- (__ \ "email").readNullable[String]
    ...
    implicit def jsonWritesDependencyUserSummary: play.api.libs.json.Writes[UserSummary] = {
      (obj: io.flow.dependency.v0.models.UserSummary) => {
        io.flow.dependency.v0.models.json.jsObjectUserSummary(obj)
      }
    }

    implicit def jsonReadsDependencyUsernamePassword: play.api.libs.json.Reads[io.flow.dependency.v0.models.UsernamePassword] = {
      for {
    ...
    implicit def jsonWritesDependencyUsernamePassword: play.api.libs.json.Writes[UsernamePassword] = {
      (obj: io.flow.dependency.v0.models.UsernamePassword) => {
        io.flow.dependency.v0.models.json.jsObjectUsernamePassword(obj)
      }
    }

    implicit def jsonReadsDependencyVersionForm: play.api.libs.json.Reads[io.flow.dependency.v0.models.VersionForm] = {
      for {
        version <- (__ \ "version").read[String]
        crossBuildVersion <- (__ \ "cross_build_version").readNullable[String]
    ...
    implicit def jsonWritesDependencyVersionForm: play.api.libs.json.Writes[VersionForm] = {
      (obj: io.flow.dependency.v0.models.VersionForm) => {
        io.flow.dependency.v0.models.json.jsObjectVersionForm(obj)
      }
    }

    implicit def jsonReadsDependencyCredentials: play.api.libs.json.Reads[io.flow.dependency.v0.models.Credentials] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "username_password" => io.flow.dependency.v0.models.json.jsonReadsDependencyUsernamePassword.reads(js)
    ...
    def jsObjectCredentials(obj: io.flow.dependency.v0.models.Credentials): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.dependency.v0.models.UsernamePassword => io.flow.dependency.v0.models.json.jsObjectUsernamePassword(x)
        case other => {
    ...
    implicit def jsonWritesDependencyCredentials: play.api.libs.json.Writes[Credentials] = {
      (obj: io.flow.dependency.v0.models.Credentials) => {
        io.flow.dependency.v0.models.json.jsObjectCredentials(obj)
      }
    }

    implicit def jsonReadsDependencyItemSummary: play.api.libs.json.Reads[io.flow.dependency.v0.models.ItemSummary] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "binary_summary" => io.flow.dependency.v0.models.json.jsonReadsDependencyBinarySummary.reads(js)
          case "library_summary" => io.flow.dependency.v0.models.json.jsonReadsDependencyLibrarySummary.reads(js)
          case "project_summary" => io.flow.dependency.v0.models.json.jsonReadsDependencyProjectSummary.reads(js)
    ...
    def jsObjectItemSummary(obj: io.flow.dependency.v0.models.ItemSummary): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.dependency.v0.models.BinarySummary => io.flow.dependency.v0.models.json.jsObjectBinarySummary(x)
        case x: io.flow.dependency.v0.models.LibrarySummary => io.flow.dependency.v0.models.json.jsObjectLibrarySummary(x)
        case x: io.flow.dependency.v0.models.ProjectSummary => io.flow.dependency.v0.models.json.jsObjectProjectSummary(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesDependencyItemSummary: play.api.libs.json.Writes[ItemSummary] = {
      (obj: io.flow.dependency.v0.models.ItemSummary) => {
        io.flow.dependency.v0.models.json.jsObjectItemSummary(obj)
      }
    }

    implicit def jsonReadsDependencyTaskData: play.api.libs.json.Reads[io.flow.dependency.v0.models.TaskData] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "task_data_upserted" => io.flow.dependency.v0.models.json.jsonReadsDependencyTaskDataUpserted.reads(js)
          case "task_data_sync" => io.flow.dependency.v0.models.json.jsonReadsDependencyTaskDataSync.reads(js)
          case "task_data_sync_one" => io.flow.dependency.v0.models.json.jsonReadsDependencyTaskDataSyncOne.reads(js)
          case "task_data_sync_libraries_by_prefix" => io.flow.dependency.v0.models.json.jsonReadsDependencyTaskDataSyncLibrariesByPrefix.reads(js)
          case "task_data_sync_organization_libraries" => io.flow.dependency.v0.models.json.jsonReadsDependencyTaskDataSyncOrganizationLibraries.reads(js)
    ...
    def jsObjectTaskData(obj: io.flow.dependency.v0.models.TaskData): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.dependency.v0.models.TaskDataUpserted => io.flow.dependency.v0.models.json.jsObjectTaskDataUpserted(x)
        case x: io.flow.dependency.v0.models.TaskDataSync => io.flow.dependency.v0.models.json.jsObjectTaskDataSync(x)
        case x: io.flow.dependency.v0.models.TaskDataSyncOne => io.flow.dependency.v0.models.json.jsObjectTaskDataSyncOne(x)
        case x: io.flow.dependency.v0.models.TaskDataSyncLibrariesByPrefix => io.flow.dependency.v0.models.json.jsObjectTaskDataSyncLibrariesByPrefix(x)
        case x: io.flow.dependency.v0.models.TaskDataSyncOrganizationLibraries => io.flow.dependency.v0.models.json.jsObjectTaskDataSyncOrganizationLibraries(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesDependencyTaskData: play.api.libs.json.Writes[TaskData] = {
      (obj: io.flow.dependency.v0.models.TaskData) => {
        io.flow.dependency.v0.models.json.jsObjectTaskData(obj)
      }
    }
  }
}
...
package io.flow.dependency.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/dependency/latest/play_2_8_client"
    val Version = "0.8.18"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private val logger = play.api.Logger("io.flow.dependency.v0.Client")
    ...
    def projectDependencyResolutions: ProjectDependencyResolutions = ProjectDependencyResolutions
    ...
    object Binaries extends Binaries {
      ...
      override def post(
        ...
        _executeRequest("POST", s"/binaries", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 401 => throw io.flow.dependency.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw io.flow.dependency.v0.errors.GenericErrorResponse(r)
      ...
      override def deleteById(
        ...
        _executeRequest("DELETE", s"/binaries/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}", requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 404 => throw io.flow.dependency.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw io.flow.dependency.v0.errors.GenericErrorResponse(r)
          case r => throw io.flow.dependency.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 204, 401, 404, 422")
        }
      }
    }
    ...
    object ProjectDependencyResolutions extends ProjectDependencyResolutions {
      override def get(
        organization: String,
        groupId: String,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.dependency.v0.models.ProjectDependencyResolution] = {
        _executeRequest("GET", s"/${play.utils.UriEncoding.encodePathSegment(organization, "UTF-8")}/project/dependencies/group/${play.utils.UriEncoding.encodePathSegment(groupId, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.dependency.v0.Client.parseJson("io.flow.dependency.v0.models.ProjectDependencyResolution", r, _.validate[io.flow.dependency.v0.models.ProjectDependencyResolution])
          case r if r.status == 401 => throw io.flow.dependency.v0.errors.UnitResponse(r.status)
          case r if r.status == 404 => throw io.flow.dependency.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.dependency.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401, 404")
        }
    ...
    object Syncs extends Syncs {
      ...
      override def postLibrariesAndPrefixByArtifactIdPrefix(
        artifactIdPrefix: String,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Unit] = {
        _executeRequest("POST", s"/syncs/libraries/prefix/${play.utils.UriEncoding.encodePathSegment(artifactIdPrefix, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.status == 204 => ()
          case r if r.status == 404 => throw io.flow.dependency.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.dependency.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 204, 404")
        }
  ...
  package interfaces {
    ...
    trait Client {
      ...
      def projectDependencyResolutions: io.flow.dependency.v0.ProjectDependencyResolutions
  ...
  trait ProjectDependencyResolutions {
    def get(
      organization: String,
      groupId: String,
      requestHeaders: Seq[(String, String)] = Nil
  ...
  trait Syncs {
    ...
    /**
     * Will sync all libraries where the artifact id starts with the specified
     * artifact_id_refix*
     */
    def postLibrariesAndPrefixByArtifactIdPrefix(
      artifactIdPrefix: String,
      requestHeaders: Seq[(String, String)] = Nil
    )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Unit]
  ...
  package errors {
    ...
    final case class GenericErrorResponse(
      ...
      lazy val genericError = _root_.io.flow.dependency.v0.Client.parseJson("io.flow.error.v0.models.GenericError", response, _.validate[io.flow.error.v0.models.GenericError])
    }
