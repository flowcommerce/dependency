 ...
 * apibuilder 0.15.11 app.apibuilder.io/flow/dependency/latest/play_2_8_client
 */
...
package io.flow.dependency.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsDependencyProjectDependencyResolutionResolved: play.api.libs.json.Reads[ProjectDependencyResolutionResolved] = {
      (__ \ "projects").read[Seq[io.flow.dependency.v0.models.ProjectSummary]].map { x => new ProjectDependencyResolutionResolved(projects = x) }
    }
    ...
    implicit def jsonReadsDependencyProjectUnresolvedSummary: play.api.libs.json.Reads[ProjectUnresolvedSummary] = {
      for {
    ...
    implicit def jsonReadsDependencyTaskDataSyncLibrariesByPrefix: play.api.libs.json.Reads[TaskDataSyncLibrariesByPrefix] = {
      for {
        userId <- (__ \ "user_id").read[String]
    ...
    implicit def jsonReadsDependencyTaskData: play.api.libs.json.Reads[TaskData] = new play.api.libs.json.Reads[TaskData] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[TaskData] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[TaskData] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
          ...
          case "task_data_sync_libraries_by_prefix" => js.validate[io.flow.dependency.v0.models.TaskDataSyncLibrariesByPrefix]
    ...
    def jsObjectTaskData(obj: io.flow.dependency.v0.models.TaskData): play.api.libs.json.JsObject = {
      obj match {
        ...
        case x: io.flow.dependency.v0.models.TaskDataSyncLibrariesByPrefix => jsObjectTaskDataSyncLibrariesByPrefix(x)
...
package io.flow.dependency.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.11 app.apibuilder.io/flow/dependency/latest/play_2_8_client"
    val Version = "0.8.18"
    val VersionMajor = 0
