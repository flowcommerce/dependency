 ...
 * Service version: 0.6.1-45-g39f57ff-b6605c65-add-sync-by-group-spec
 * apibuilder 0.14.3 app.apibuilder.io/flow/dependency/0.6.1-45-g39f57ff-b6605c65-add-sync-by-group-spec/play_2_6_client
 */
...
package io.flow.dependency.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/flow/dependency/0.6.1-45-g39f57ff-b6605c65-add-sync-by-group-spec/play_2_6_client"
    val Version = "0.6.1-45-g39f57ff-b6605c65-add-sync-by-group-spec"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Syncs extends Syncs {
      ...
      override def postLibraries(
        ...
        _executeRequest("POST", s"/syncs/libraries", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 204 => ()
          case r if r.status == 404 => throw io.flow.dependency.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.dependency.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 204, 404")
        }
  ...
  trait Syncs {
    ...
    /**
     * Synchronize libraries with given params
     * 
     * @param groupId Synchronize libraries with given group_id
     */
    def postLibraries(
      groupId: _root_.scala.Option[String] = None,
      requestHeaders: Seq[(String, String)] = Nil
