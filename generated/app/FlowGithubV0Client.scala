 ...
 * apibuilder:0.12.20 https://app.apibuilder.io/flow/github/0.0.3/play_2_4_client
 */
package io.flow.github.v0.models {
   ...
   * @param url
   * @param sha
   * @param mode 100644 file (blob), 100755 executable (blob), 040000 subdirectory
   * (tree), 160000 submodule (commit)
   */
  case class Node(
    path: String,
    mode: String,
...
package io.flow.github.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.20 https://app.apibuilder.io/flow/github/0.0.3/play_2_4_client"
    val Version = "0.0.3"
    val VersionMajor = 0
