 ...
 * apibuilder 0.14.3 app.apibuilder.io/flow/github/0.0.8/play_2_6_client
 */
...
package io.flow.github.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsGithubPullRequest: play.api.libs.json.Reads[PullRequest] = {
      ...
      } yield PullRequest(id, url, number)
    }
...
package io.flow.github.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/flow/github/0.0.8/play_2_6_client"
    val Version = "0.0.8"
    val VersionMajor = 0
