 ...
 * apibuilder 0.14.3 app.apibuilder.io/flow/github/0.0.10/play_2_6_client
 */
  ...
  package object json {
    ...
    implicit def jsonReadsGithubPullRequest: play.api.libs.json.Reads[PullRequest] = {
      for {
        ...
        htmlUrl <- (__ \ "html_url").read[String]
      } yield PullRequest(id, url, number, htmlUrl)
    }
...
package io.flow.github.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/flow/github/0.0.10/play_2_6_client"
    val Version = "0.0.10"
    val VersionMajor = 0
