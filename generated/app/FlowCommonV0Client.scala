 ...
 * apibuilder 0.14.3 app.apibuilder.io/flow/common/0.5.69/play_2_6_client
 */
package io.flow.common.v0.models {
  ...
  final case class MerchantOfRecordEntity(
    name: String,
    vat: io.flow.common.v0.models.VatRegistration,
    streets: Seq[String],
    city: String,
    province: _root_.scala.Option[String] = None,
    postal: _root_.scala.Option[String] = None,
   ...
   */
  final case class VatRegistration(
    number: String,
    country: String
  )
...
package io.flow.common.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsCommonMerchantOfRecordEntity: play.api.libs.json.Reads[MerchantOfRecordEntity] = {
      for {
        name <- (__ \ "name").read[String]
        vat <- (__ \ "vat").read[io.flow.common.v0.models.VatRegistration]
        ...
        phone <- (__ \ "phone").readNullable[String]
        email <- (__ \ "email").readNullable[String]
      } yield MerchantOfRecordEntity(name, vat, streets, city, province, postal, country, phone, email)
    }

    def jsObjectMerchantOfRecordEntity(obj: io.flow.common.v0.models.MerchantOfRecordEntity): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "name" -> play.api.libs.json.JsString(obj.name),
        "vat" -> jsObjectVatRegistration(obj.vat),
    ...
    implicit def jsonReadsCommonVatRegistration: play.api.libs.json.Reads[VatRegistration] = {
      for {
        number <- (__ \ "number").read[String]
        country <- (__ \ "country").read[String]
      } yield VatRegistration(number, country)
    }

    def jsObjectVatRegistration(obj: io.flow.common.v0.models.VatRegistration): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "number" -> play.api.libs.json.JsString(obj.number),
        "country" -> play.api.libs.json.JsString(obj.country)
      )
    ...
    implicit def jsonWritesCommonVatRegistration: play.api.libs.json.Writes[VatRegistration] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.VatRegistration] {
        def writes(obj: io.flow.common.v0.models.VatRegistration) = {
          jsObjectVatRegistration(obj)
        }
      }
    }
...
package io.flow.common.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/flow/common/0.5.69/play_2_6_client"
    val Version = "0.5.69"
    val VersionMajor = 0
