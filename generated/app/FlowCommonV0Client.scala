...
package io.flow.common.v0.models {
  ...
  object AttributeDataType {
     ...
     */
    case object Integer extends AttributeDataType { override def toString = "integer" }
    /**
  ...
  object EntityIdentifierType {
     ...
     */
    case object Ioss extends EntityIdentifierType { override def toString = "ioss" }
    /**
     ...
     */
    case object Voec extends EntityIdentifierType { override def toString = "voec" }
  ...
  object OrganizationStatus {
     ...
     * updated, etc...
     */
    case object Inactive extends OrganizationStatus { override def toString = "inactive" }
    /**
     * Manually deactivated
     */
    case object Deactivated extends OrganizationStatus { override def toString = "deactivated" }
...
package io.flow.common.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsCommonEntityIdentifierType = new play.api.libs.json.Reads[io.flow.common.v0.models.EntityIdentifierType] {
    ...
    implicit def jsonWritesCommonEntityIdentifierType: play.api.libs.json.Writes[EntityIdentifierType] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.EntityIdentifierType] {
        def writes(obj: io.flow.common.v0.models.EntityIdentifierType) = {
    ...
    implicit val jsonReadsCommonOrganizationStatus = new play.api.libs.json.Reads[io.flow.common.v0.models.OrganizationStatus] {
    ...
    implicit def jsonWritesCommonOrganizationStatus: play.api.libs.json.Writes[OrganizationStatus] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.OrganizationStatus] {
        def writes(obj: io.flow.common.v0.models.OrganizationStatus) = {
    ...
    implicit def jsonWritesCommonEntityIdentifier: play.api.libs.json.Writes[EntityIdentifier] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.EntityIdentifier] {
        def writes(obj: io.flow.common.v0.models.EntityIdentifier) = {
