 ...
 * Service version: 0.16.72
 * apibuilder 0.15.33 app.apibuilder.io/flow/common/latest/play_2_8_client
 */
  ...
  package object json {
    ...
    implicit def jsonWritesCommonEntityIdentifierType: play.api.libs.json.Writes[EntityIdentifierType] = {
      (obj: io.flow.common.v0.models.EntityIdentifierType) => {
        jsonWritesCommonEntityIdentifierType(obj)
      }
    }
    ...
    implicit def jsonWritesCommonOrganizationStatus: play.api.libs.json.Writes[OrganizationStatus] = {
      (obj: io.flow.common.v0.models.OrganizationStatus) => {
        jsonWritesCommonOrganizationStatus(obj)
      }
    }
    ...
    implicit def jsonWritesCommonOrganizationType: play.api.libs.json.Writes[OrganizationType] = {
      (obj: io.flow.common.v0.models.OrganizationType) => {
        jsonWritesCommonOrganizationType(obj)
      }
    }
    ...
    implicit def jsonReadsCommonChannelReference: play.api.libs.json.Reads[ChannelReference] = {
      (__ \ "id").read[String].map { x => new ChannelReference(id = x) }
    }
    ...
    implicit def jsonReadsCommonEntityIdentifier: play.api.libs.json.Reads[EntityIdentifier] = {
      for {
    ...
    implicit def jsonReadsCommonLogoImageSetStatic: play.api.libs.json.Reads[LogoImageSetStatic] = {
      for {
    ...
    def jsObjectLogoImageSetStatic(obj: io.flow.common.v0.models.LogoImageSetStatic): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "medium" -> jsObjectLogoImageStatic(obj.medium)
      ) ++ (obj.small match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("small" -> jsObjectLogoImageStatic(x))
      }) ++
      (obj.large match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("large" -> jsObjectLogoImageStatic(x))
    ...
    implicit def jsonWritesCommonLogoImageSetStatic: play.api.libs.json.Writes[LogoImageSetStatic] = {
      (obj: io.flow.common.v0.models.LogoImageSetStatic) => {
        jsObjectLogoImageSetStatic(obj)
      }
    }

    implicit def jsonReadsCommonLogoImageStatic: play.api.libs.json.Reads[LogoImageStatic] = {
      for {
    ...
    implicit def jsonWritesCommonLogoImageStatic: play.api.libs.json.Writes[LogoImageStatic] = {
      (obj: io.flow.common.v0.models.LogoImageStatic) => {
        jsObjectLogoImageStatic(obj)
      }
    }

    implicit def jsonReadsCommonLogoImageSvg: play.api.libs.json.Reads[LogoImageSvg] = {
      (__ \ "url").read[String].map { x => new LogoImageSvg(url = x) }
    }
    ...
    def jsObjectMerchantOfRecordEntity(obj: io.flow.common.v0.models.MerchantOfRecordEntity): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("vat" -> jsObjectMerchantOfRecordEntityRegistration(x))
      }) ++
    ...
    implicit def jsonReadsCommonDiscountOffer: play.api.libs.json.Reads[DiscountOffer] = (js: play.api.libs.json.JsValue) => {
    ...
    implicit def jsonReadsCommonExpandableOrganization: play.api.libs.json.Reads[ExpandableOrganization] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
    ...
    implicit def jsonReadsCommonExpandableUser: play.api.libs.json.Reads[ExpandableUser] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
    ...
    implicit def jsonReadsCommonInputSpecificationLimitation: play.api.libs.json.Reads[InputSpecificationLimitation] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
    ...
    implicit def jsonReadsCommonLogoImage: play.api.libs.json.Reads[LogoImage] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "svg" => js.validate[io.flow.common.v0.models.LogoImageSvg]
          case "static" => js.validate[io.flow.common.v0.models.LogoImageSetStatic]
    ...
    def jsObjectLogoImage(obj: io.flow.common.v0.models.LogoImage): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.LogoImageSvg => jsObjectLogoImageSvg(x)
        case x: io.flow.common.v0.models.LogoImageSetStatic => jsObjectLogoImageSetStatic(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesCommonLogoImage: play.api.libs.json.Writes[LogoImage] = {
      (obj: io.flow.common.v0.models.LogoImage) => {
        jsObjectLogoImage(obj)
      }
    }

    implicit def jsonReadsCommonPriceSource: play.api.libs.json.Reads[PriceSource] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
    ...
    implicit def jsonReadsCommonRepeatSchedule: play.api.libs.json.Reads[RepeatSchedule] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
...
package io.flow.common.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.33 app.apibuilder.io/flow/common/latest/play_2_8_client"
    val Version = "0.16.72"
    val VersionMajor = 0
