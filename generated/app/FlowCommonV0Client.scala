 ...
 * apibuilder 0.14.75 app.apibuilder.io/flow/common/0.7.50/play_2_6_client
 */
...
package io.flow.common.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsCommonCustomer: play.api.libs.json.Reads[Customer] = {
      ...
      } yield Customer(name, number, phone, email, address, invoice)
    }
    ...
    implicit def jsonReadsCommonCustomerForm: play.api.libs.json.Reads[CustomerForm] = {
      for {
        name <- (__ \ "name").readNullable[io.flow.common.v0.models.Name]
        number <- (__ \ "number").readNullable[String]
        phone <- (__ \ "phone").readNullable[String]
        ...
        address <- (__ \ "address").readNullable[io.flow.common.v0.models.BillingAddress]
        invoice <- (__ \ "invoice").readNullable[io.flow.common.v0.models.CustomerInvoice]
      } yield CustomerForm(name, number, phone, email, address, invoice)
    }

    def jsObjectCustomerForm(obj: io.flow.common.v0.models.CustomerForm): play.api.libs.json.JsObject = {
      (obj.name match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("name" -> jsObjectName(x))
      }) ++
    ...
    implicit def jsonWritesCommonCustomerForm: play.api.libs.json.Writes[CustomerForm] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.CustomerForm] {
        def writes(obj: io.flow.common.v0.models.CustomerForm) = {
...
package io.flow.common.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.75 app.apibuilder.io/flow/common/0.7.50/play_2_6_client"
    val Version = "0.7.50"
    val VersionMajor = 0
