 ...
 * Service version: 0.19.73
 * User agent: apibuilder app.apibuilder.io/flow/common/latest/play_2_8_client
 */
package io.flow.common.v0.models {
  ...
  object DiscountOfferDiscriminator {
    ...
    private val byName: Map[String, DiscountOfferDiscriminator] = all.map(x => x.toString.toLowerCase -> x).toMap
  ...
  object ExpandableOrganizationDiscriminator {
    ...
    private val byName: Map[String, ExpandableOrganizationDiscriminator] = all.map(x => x.toString.toLowerCase -> x).toMap
  ...
  object ExpandableUserDiscriminator {
    ...
    private val byName: Map[String, ExpandableUserDiscriminator] = all.map(x => x.toString.toLowerCase -> x).toMap
  ...
  object InputSpecificationLimitationDiscriminator {
    ...
    private val byName: Map[String, InputSpecificationLimitationDiscriminator] = all.map(x => x.toString.toLowerCase -> x).toMap
  ...
  object LogoImageDiscriminator {
    ...
    private val byName: Map[String, LogoImageDiscriminator] = all.map(x => x.toString.toLowerCase -> x).toMap
  ...
  object PriceSourceDiscriminator {
    ...
    private val byName: Map[String, PriceSourceDiscriminator] = all.map(x => x.toString.toLowerCase -> x).toMap
  ...
  object RepeatScheduleDiscriminator {
    ...
    private val byName: Map[String, RepeatScheduleDiscriminator] = all.map(x => x.toString.toLowerCase -> x).toMap
  ...
  final case class Organization(
    ...
    `type`: _root_.scala.Option[io.flow.common.v0.models.OrganizationType] = None
  ...
  object EntityIdentifierType {
    ...
    /**
     * The Centralized Customs Settlement Procedure (ZAZ) to comply with VAT on
     * imported goods. see:
     * https://www.bazg.admin.ch/bazg/en/home/services/services-companies/dienstleistungen-firmen/das-zollkonto-im-zentralisierten-abrechnungsverfahren-des-zolls.html
     */
    case object Zaz extends EntityIdentifierType {
      override def toString = "zaz"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
     ...
     * above.
     */
    val all: scala.List[EntityIdentifierType] = scala.List(Ioss, Voec, Zaz)
  ...
  sealed trait OrganizationType extends _root_.scala.Product with _root_.scala.Serializable

  object OrganizationType {

    case object Standalone extends OrganizationType { override def toString = "standalone" }
    case object Channel extends OrganizationType { override def toString = "channel" }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
     * generated. We want to make it easy and obvious for users of
     ...
     * with the camel cased values above.
     */
    final case class UNDEFINED(override val toString: String) extends OrganizationType
     ...
     * above.
     */
    val all: scala.List[OrganizationType] = scala.List(Standalone, Channel)

    private
    val byName: Map[String, OrganizationType] = all.map(x => x.toString.toLowerCase -> x).toMap

    def apply(value: String): OrganizationType = fromString(value).getOrElse(UNDEFINED(value))

    def fromString(value: String): _root_.scala.Option[OrganizationType] = byName.get(value.toLowerCase)
  ...
  object UnitOfMeasurement {
     ...
     * above.
     */
    val all: scala.List[UnitOfMeasurement] = scala.List(Millimeter, Centimeter, Inch, Foot, CubicInch, CubicFoot, CubicMillimeter, CubicCentimeter, CubicMeter, Gram, Kilogram, Meter, Ounce, Pound)
...
package io.flow.common.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsCommonAttributeDataType: play.api.libs.json.Reads[io.flow.common.v0.models.AttributeDataType] = new play.api.libs.json.Reads[io.flow.common.v0.models.AttributeDataType] {
    ...
    implicit def jsonWritesCommonAttributeDataType: play.api.libs.json.Writes[AttributeDataType] = {
      (obj: io.flow.common.v0.models.AttributeDataType) => {
        io.flow.common.v0.models.json.jsonWritesCommonAttributeDataType(obj)
      }
    }

    implicit val jsonReadsCommonAvailabilityStatus: play.api.libs.json.Reads[io.flow.common.v0.models.AvailabilityStatus] = new play.api.libs.json.Reads[io.flow.common.v0.models.AvailabilityStatus] {
    ...
    implicit def jsonWritesCommonAvailabilityStatus: play.api.libs.json.Writes[AvailabilityStatus] = {
      (obj: io.flow.common.v0.models.AvailabilityStatus) => {
        io.flow.common.v0.models.json.jsonWritesCommonAvailabilityStatus(obj)
      }
    }

    implicit val jsonReadsCommonCalendar: play.api.libs.json.Reads[io.flow.common.v0.models.Calendar] = new play.api.libs.json.Reads[io.flow.common.v0.models.Calendar] {
    ...
    implicit def jsonWritesCommonCalendar: play.api.libs.json.Writes[Calendar] = {
      (obj: io.flow.common.v0.models.Calendar) => {
        io.flow.common.v0.models.json.jsonWritesCommonCalendar(obj)
      }
    }

    implicit val jsonReadsCommonCapability: play.api.libs.json.Reads[io.flow.common.v0.models.Capability] = new play.api.libs.json.Reads[io.flow.common.v0.models.Capability] {
    ...
    implicit def jsonWritesCommonCapability: play.api.libs.json.Writes[Capability] = {
      (obj: io.flow.common.v0.models.Capability) => {
        io.flow.common.v0.models.json.jsonWritesCommonCapability(obj)
      }
    }

    implicit val jsonReadsCommonChangeType: play.api.libs.json.Reads[io.flow.common.v0.models.ChangeType] = new play.api.libs.json.Reads[io.flow.common.v0.models.ChangeType] {
    ...
    implicit def jsonWritesCommonChangeType: play.api.libs.json.Writes[ChangeType] = {
      (obj: io.flow.common.v0.models.ChangeType) => {
        io.flow.common.v0.models.json.jsonWritesCommonChangeType(obj)
      }
    }

    implicit val jsonReadsCommonCurrencyLabelFormatter: play.api.libs.json.Reads[io.flow.common.v0.models.CurrencyLabelFormatter] = new play.api.libs.json.Reads[io.flow.common.v0.models.CurrencyLabelFormatter] {
    ...
    implicit def jsonWritesCommonCurrencyLabelFormatter: play.api.libs.json.Writes[CurrencyLabelFormatter] = {
      (obj: io.flow.common.v0.models.CurrencyLabelFormatter) => {
        io.flow.common.v0.models.json.jsonWritesCommonCurrencyLabelFormatter(obj)
      }
    }

    implicit val jsonReadsCommonCurrencySymbolFormat: play.api.libs.json.Reads[io.flow.common.v0.models.CurrencySymbolFormat] = new play.api.libs.json.Reads[io.flow.common.v0.models.CurrencySymbolFormat] {
    ...
    implicit def jsonWritesCommonCurrencySymbolFormat: play.api.libs.json.Writes[CurrencySymbolFormat] = {
      (obj: io.flow.common.v0.models.CurrencySymbolFormat) => {
        io.flow.common.v0.models.json.jsonWritesCommonCurrencySymbolFormat(obj)
      }
    }

    implicit val jsonReadsCommonDayOfWeek: play.api.libs.json.Reads[io.flow.common.v0.models.DayOfWeek] = new play.api.libs.json.Reads[io.flow.common.v0.models.DayOfWeek] {
    ...
    implicit def jsonWritesCommonDayOfWeek: play.api.libs.json.Writes[DayOfWeek] = {
      (obj: io.flow.common.v0.models.DayOfWeek) => {
        io.flow.common.v0.models.json.jsonWritesCommonDayOfWeek(obj)
      }
    }

    implicit val jsonReadsCommonDeliveredDuty: play.api.libs.json.Reads[io.flow.common.v0.models.DeliveredDuty] = new play.api.libs.json.Reads[io.flow.common.v0.models.DeliveredDuty] {
    ...
    implicit def jsonWritesCommonDeliveredDuty: play.api.libs.json.Writes[DeliveredDuty] = {
      (obj: io.flow.common.v0.models.DeliveredDuty) => {
        io.flow.common.v0.models.json.jsonWritesCommonDeliveredDuty(obj)
      }
    }

    implicit val jsonReadsCommonDiscountTarget: play.api.libs.json.Reads[io.flow.common.v0.models.DiscountTarget] = new play.api.libs.json.Reads[io.flow.common.v0.models.DiscountTarget] {
    ...
    implicit def jsonWritesCommonDiscountTarget: play.api.libs.json.Writes[DiscountTarget] = {
      (obj: io.flow.common.v0.models.DiscountTarget) => {
        io.flow.common.v0.models.json.jsonWritesCommonDiscountTarget(obj)
      }
    }

    implicit val jsonReadsCommonEntityIdentifierType: play.api.libs.json.Reads[io.flow.common.v0.models.EntityIdentifierType] = new play.api.libs.json.Reads[io.flow.common.v0.models.EntityIdentifierType] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.common.v0.models.EntityIdentifierType] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.common.v0.models.EntityIdentifierType(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.EntityIdentifierType(v))
              case err: play.api.libs.json.JsError =>
                (js \ "entity_identifier_type").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.EntityIdentifierType(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
    ...
    def jsonWritesCommonEntityIdentifierType(obj: io.flow.common.v0.models.EntityIdentifierType) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectEntityIdentifierType(obj: io.flow.common.v0.models.EntityIdentifierType) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesCommonEntityIdentifierType: play.api.libs.json.Writes[EntityIdentifierType] = {
      (obj: io.flow.common.v0.models.EntityIdentifierType) => {
        io.flow.common.v0.models.json.jsonWritesCommonEntityIdentifierType(obj)
      }
    }

    implicit val jsonReadsCommonEnvironment: play.api.libs.json.Reads[io.flow.common.v0.models.Environment] = new play.api.libs.json.Reads[io.flow.common.v0.models.Environment] {
    ...
    implicit def jsonWritesCommonEnvironment: play.api.libs.json.Writes[Environment] = {
      (obj: io.flow.common.v0.models.Environment) => {
        io.flow.common.v0.models.json.jsonWritesCommonEnvironment(obj)
      }
    }

    implicit val jsonReadsCommonExceptionType: play.api.libs.json.Reads[io.flow.common.v0.models.ExceptionType] = new play.api.libs.json.Reads[io.flow.common.v0.models.ExceptionType] {
    ...
    implicit def jsonWritesCommonExceptionType: play.api.libs.json.Writes[ExceptionType] = {
      (obj: io.flow.common.v0.models.ExceptionType) => {
        io.flow.common.v0.models.json.jsonWritesCommonExceptionType(obj)
      }
    }

    implicit val jsonReadsCommonGoodsSupply: play.api.libs.json.Reads[io.flow.common.v0.models.GoodsSupply] = new play.api.libs.json.Reads[io.flow.common.v0.models.GoodsSupply] {
    ...
    implicit def jsonWritesCommonGoodsSupply: play.api.libs.json.Writes[GoodsSupply] = {
      (obj: io.flow.common.v0.models.GoodsSupply) => {
        io.flow.common.v0.models.json.jsonWritesCommonGoodsSupply(obj)
      }
    }

    implicit val jsonReadsCommonHolidayCalendar: play.api.libs.json.Reads[io.flow.common.v0.models.HolidayCalendar] = new play.api.libs.json.Reads[io.flow.common.v0.models.HolidayCalendar] {
    ...
    implicit def jsonWritesCommonHolidayCalendar: play.api.libs.json.Writes[HolidayCalendar] = {
      (obj: io.flow.common.v0.models.HolidayCalendar) => {
        io.flow.common.v0.models.json.jsonWritesCommonHolidayCalendar(obj)
      }
    }

    implicit val jsonReadsCommonIncludedLevyKey: play.api.libs.json.Reads[io.flow.common.v0.models.IncludedLevyKey] = new play.api.libs.json.Reads[io.flow.common.v0.models.IncludedLevyKey] {
    ...
    implicit def jsonWritesCommonIncludedLevyKey: play.api.libs.json.Writes[IncludedLevyKey] = {
      (obj: io.flow.common.v0.models.IncludedLevyKey) => {
        io.flow.common.v0.models.json.jsonWritesCommonIncludedLevyKey(obj)
      }
    }

    implicit val jsonReadsCommonIncoterm: play.api.libs.json.Reads[io.flow.common.v0.models.Incoterm] = new play.api.libs.json.Reads[io.flow.common.v0.models.Incoterm] {
    ...
    implicit def jsonWritesCommonIncoterm: play.api.libs.json.Writes[Incoterm] = {
      (obj: io.flow.common.v0.models.Incoterm) => {
        io.flow.common.v0.models.json.jsonWritesCommonIncoterm(obj)
      }
    }

    implicit val jsonReadsCommonInputSpecificationType: play.api.libs.json.Reads[io.flow.common.v0.models.InputSpecificationType] = new play.api.libs.json.Reads[io.flow.common.v0.models.InputSpecificationType] {
    ...
    implicit def jsonWritesCommonInputSpecificationType: play.api.libs.json.Writes[InputSpecificationType] = {
      (obj: io.flow.common.v0.models.InputSpecificationType) => {
        io.flow.common.v0.models.json.jsonWritesCommonInputSpecificationType(obj)
      }
    }

    implicit val jsonReadsCommonMarginType: play.api.libs.json.Reads[io.flow.common.v0.models.MarginType] = new play.api.libs.json.Reads[io.flow.common.v0.models.MarginType] {
    ...
    implicit def jsonWritesCommonMarginType: play.api.libs.json.Writes[MarginType] = {
      (obj: io.flow.common.v0.models.MarginType) => {
        io.flow.common.v0.models.json.jsonWritesCommonMarginType(obj)
      }
    }

    implicit val jsonReadsCommonMeasurementSystem: play.api.libs.json.Reads[io.flow.common.v0.models.MeasurementSystem] = new play.api.libs.json.Reads[io.flow.common.v0.models.MeasurementSystem] {
    ...
    implicit def jsonWritesCommonMeasurementSystem: play.api.libs.json.Writes[MeasurementSystem] = {
      (obj: io.flow.common.v0.models.MeasurementSystem) => {
        io.flow.common.v0.models.json.jsonWritesCommonMeasurementSystem(obj)
      }
    }

    implicit val jsonReadsCommonMerchantOfRecord: play.api.libs.json.Reads[io.flow.common.v0.models.MerchantOfRecord] = new play.api.libs.json.Reads[io.flow.common.v0.models.MerchantOfRecord] {
    ...
    implicit def jsonWritesCommonMerchantOfRecord: play.api.libs.json.Writes[MerchantOfRecord] = {
      (obj: io.flow.common.v0.models.MerchantOfRecord) => {
        io.flow.common.v0.models.json.jsonWritesCommonMerchantOfRecord(obj)
      }
    }

    implicit val jsonReadsCommonOrderMerchantOfRecord: play.api.libs.json.Reads[io.flow.common.v0.models.OrderMerchantOfRecord] = new play.api.libs.json.Reads[io.flow.common.v0.models.OrderMerchantOfRecord] {
    ...
    implicit def jsonWritesCommonOrderMerchantOfRecord: play.api.libs.json.Writes[OrderMerchantOfRecord] = {
      (obj: io.flow.common.v0.models.OrderMerchantOfRecord) => {
        io.flow.common.v0.models.json.jsonWritesCommonOrderMerchantOfRecord(obj)
      }
    }

    implicit val jsonReadsCommonOrganizationStatus: play.api.libs.json.Reads[io.flow.common.v0.models.OrganizationStatus] = new play.api.libs.json.Reads[io.flow.common.v0.models.OrganizationStatus] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.common.v0.models.OrganizationStatus] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.common.v0.models.OrganizationStatus(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.OrganizationStatus(v))
              case err: play.api.libs.json.JsError =>
                (js \ "organization_status").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.OrganizationStatus(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
    ...
    def jsonWritesCommonOrganizationStatus(obj: io.flow.common.v0.models.OrganizationStatus) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectOrganizationStatus(obj: io.flow.common.v0.models.OrganizationStatus) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesCommonOrganizationStatus: play.api.libs.json.Writes[OrganizationStatus] = {
      (obj: io.flow.common.v0.models.OrganizationStatus) => {
        io.flow.common.v0.models.json.jsonWritesCommonOrganizationStatus(obj)
      }
    }

    implicit val jsonReadsCommonOrganizationType: play.api.libs.json.Reads[io.flow.common.v0.models.OrganizationType] = new play.api.libs.json.Reads[io.flow.common.v0.models.OrganizationType] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.common.v0.models.OrganizationType] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.common.v0.models.OrganizationType(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.OrganizationType(v))
              case err: play.api.libs.json.JsError =>
                (js \ "organization_type").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.OrganizationType(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
    ...
    def jsonWritesCommonOrganizationType(obj: io.flow.common.v0.models.OrganizationType) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectOrganizationType(obj: io.flow.common.v0.models.OrganizationType) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesCommonOrganizationType: play.api.libs.json.Writes[OrganizationType] = {
      (obj: io.flow.common.v0.models.OrganizationType) => {
        io.flow.common.v0.models.json.jsonWritesCommonOrganizationType(obj)
      }
    }

    implicit val jsonReadsCommonPriceBookStatus: play.api.libs.json.Reads[io.flow.common.v0.models.PriceBookStatus] = new play.api.libs.json.Reads[io.flow.common.v0.models.PriceBookStatus] {
    ...
    implicit def jsonWritesCommonPriceBookStatus: play.api.libs.json.Writes[PriceBookStatus] = {
      (obj: io.flow.common.v0.models.PriceBookStatus) => {
        io.flow.common.v0.models.json.jsonWritesCommonPriceBookStatus(obj)
      }
    }

    implicit val jsonReadsCommonRole: play.api.libs.json.Reads[io.flow.common.v0.models.Role] = new play.api.libs.json.Reads[io.flow.common.v0.models.Role] {
    ...
    implicit def jsonWritesCommonRole: play.api.libs.json.Writes[Role] = {
      (obj: io.flow.common.v0.models.Role) => {
        io.flow.common.v0.models.json.jsonWritesCommonRole(obj)
      }
    }

    implicit val jsonReadsCommonRoundingMethod: play.api.libs.json.Reads[io.flow.common.v0.models.RoundingMethod] = new play.api.libs.json.Reads[io.flow.common.v0.models.RoundingMethod] {
    ...
    implicit def jsonWritesCommonRoundingMethod: play.api.libs.json.Writes[RoundingMethod] = {
      (obj: io.flow.common.v0.models.RoundingMethod) => {
        io.flow.common.v0.models.json.jsonWritesCommonRoundingMethod(obj)
      }
    }

    implicit val jsonReadsCommonRoundingType: play.api.libs.json.Reads[io.flow.common.v0.models.RoundingType] = new play.api.libs.json.Reads[io.flow.common.v0.models.RoundingType] {
    ...
    implicit def jsonWritesCommonRoundingType: play.api.libs.json.Writes[RoundingType] = {
      (obj: io.flow.common.v0.models.RoundingType) => {
        io.flow.common.v0.models.json.jsonWritesCommonRoundingType(obj)
      }
    }

    implicit val jsonReadsCommonScheduleExceptionStatus: play.api.libs.json.Reads[io.flow.common.v0.models.ScheduleExceptionStatus] = new play.api.libs.json.Reads[io.flow.common.v0.models.ScheduleExceptionStatus] {
    ...
    implicit def jsonWritesCommonScheduleExceptionStatus: play.api.libs.json.Writes[ScheduleExceptionStatus] = {
      (obj: io.flow.common.v0.models.ScheduleExceptionStatus) => {
        io.flow.common.v0.models.json.jsonWritesCommonScheduleExceptionStatus(obj)
      }
    }

    implicit val jsonReadsCommonSortDirection: play.api.libs.json.Reads[io.flow.common.v0.models.SortDirection] = new play.api.libs.json.Reads[io.flow.common.v0.models.SortDirection] {
    ...
    implicit def jsonWritesCommonSortDirection: play.api.libs.json.Writes[SortDirection] = {
      (obj: io.flow.common.v0.models.SortDirection) => {
        io.flow.common.v0.models.json.jsonWritesCommonSortDirection(obj)
      }
    }

    implicit val jsonReadsCommonUnitOfMeasurement: play.api.libs.json.Reads[io.flow.common.v0.models.UnitOfMeasurement] = new play.api.libs.json.Reads[io.flow.common.v0.models.UnitOfMeasurement] {
    ...
    implicit def jsonWritesCommonUnitOfMeasurement: play.api.libs.json.Writes[UnitOfMeasurement] = {
      (obj: io.flow.common.v0.models.UnitOfMeasurement) => {
        io.flow.common.v0.models.json.jsonWritesCommonUnitOfMeasurement(obj)
      }
    }

    implicit val jsonReadsCommonUnitOfTime: play.api.libs.json.Reads[io.flow.common.v0.models.UnitOfTime] = new play.api.libs.json.Reads[io.flow.common.v0.models.UnitOfTime] {
    ...
    implicit def jsonWritesCommonUnitOfTime: play.api.libs.json.Writes[UnitOfTime] = {
      (obj: io.flow.common.v0.models.UnitOfTime) => {
        io.flow.common.v0.models.json.jsonWritesCommonUnitOfTime(obj)
      }
    }

    implicit val jsonReadsCommonUserStatus: play.api.libs.json.Reads[io.flow.common.v0.models.UserStatus] = new play.api.libs.json.Reads[io.flow.common.v0.models.UserStatus] {
    ...
    implicit def jsonWritesCommonUserStatus: play.api.libs.json.Writes[UserStatus] = {
      (obj: io.flow.common.v0.models.UserStatus) => {
        io.flow.common.v0.models.json.jsonWritesCommonUserStatus(obj)
      }
    }

    implicit val jsonReadsCommonValueAddedService: play.api.libs.json.Reads[io.flow.common.v0.models.ValueAddedService] = new play.api.libs.json.Reads[io.flow.common.v0.models.ValueAddedService] {
    ...
    implicit def jsonWritesCommonValueAddedService: play.api.libs.json.Writes[ValueAddedService] = {
      (obj: io.flow.common.v0.models.ValueAddedService) => {
        io.flow.common.v0.models.json.jsonWritesCommonValueAddedService(obj)
      }
    }

    implicit val jsonReadsCommonVisibility: play.api.libs.json.Reads[io.flow.common.v0.models.Visibility] = new play.api.libs.json.Reads[io.flow.common.v0.models.Visibility] {
    ...
    implicit def jsonWritesCommonVisibility: play.api.libs.json.Writes[Visibility] = {
      (obj: io.flow.common.v0.models.Visibility) => {
        io.flow.common.v0.models.json.jsonWritesCommonVisibility(obj)
      }
    }

    implicit def jsonReadsCommonAddress: play.api.libs.json.Reads[io.flow.common.v0.models.Address] = {
      for {
    ...
    implicit def jsonWritesCommonAddress: play.api.libs.json.Writes[Address] = {
      (obj: io.flow.common.v0.models.Address) => {
        io.flow.common.v0.models.json.jsObjectAddress(obj)
      }
    }

    implicit def jsonReadsCommonBillingAddress: play.api.libs.json.Reads[io.flow.common.v0.models.BillingAddress] = {
      for {
    ...
    implicit def jsonWritesCommonBillingAddress: play.api.libs.json.Writes[BillingAddress] = {
      (obj: io.flow.common.v0.models.BillingAddress) => {
        io.flow.common.v0.models.json.jsObjectBillingAddress(obj)
      }
    }

    implicit def jsonReadsCommonCatalogItemReference: play.api.libs.json.Reads[io.flow.common.v0.models.CatalogItemReference] = {
      for {
    ...
    implicit def jsonWritesCommonCatalogItemReference: play.api.libs.json.Writes[CatalogItemReference] = {
      (obj: io.flow.common.v0.models.CatalogItemReference) => {
        io.flow.common.v0.models.json.jsObjectCatalogItemReference(obj)
      }
    }

    implicit def jsonReadsCommonCatalogItemSummary: play.api.libs.json.Reads[io.flow.common.v0.models.CatalogItemSummary] = {
      for {
        number <- (__ \ "number").read[String]
    ...
    implicit def jsonWritesCommonCatalogItemSummary: play.api.libs.json.Writes[CatalogItemSummary] = {
      (obj: io.flow.common.v0.models.CatalogItemSummary) => {
        io.flow.common.v0.models.json.jsObjectCatalogItemSummary(obj)
      }
    }

    implicit def jsonReadsCommonChannelReference: play.api.libs.json.Reads[io.flow.common.v0.models.ChannelReference] = {
      (__ \ "id").read[String].map { x => ChannelReference(id = x) }
    }

    def jsObjectChannelReference(obj: io.flow.common.v0.models.ChannelReference): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id)
      )
    }

    implicit def jsonWritesCommonChannelReference: play.api.libs.json.Writes[ChannelReference] = {
      (obj: io.flow.common.v0.models.ChannelReference) => {
        io.flow.common.v0.models.json.jsObjectChannelReference(obj)
      }
    }

    implicit def jsonReadsCommonCheckoutReference: play.api.libs.json.Reads[io.flow.common.v0.models.CheckoutReference] = {
      (__ \ "id").read[String].map { x => CheckoutReference(id = x) }
    }
    ...
    implicit def jsonWritesCommonCheckoutReference: play.api.libs.json.Writes[CheckoutReference] = {
      (obj: io.flow.common.v0.models.CheckoutReference) => {
        io.flow.common.v0.models.json.jsObjectCheckoutReference(obj)
      }
    }

    implicit def jsonReadsCommonContact: play.api.libs.json.Reads[io.flow.common.v0.models.Contact] = {
      for {
    ...
    implicit def jsonWritesCommonContact: play.api.libs.json.Writes[Contact] = {
      (obj: io.flow.common.v0.models.Contact) => {
        io.flow.common.v0.models.json.jsObjectContact(obj)
      }
    }

    implicit def jsonReadsCommonCustomerInvoice: play.api.libs.json.Reads[io.flow.common.v0.models.CustomerInvoice] = {
      (__ \ "address").readNullable[io.flow.common.v0.models.BillingAddress].map { x => CustomerInvoice(address = x) }
    }
    ...
    implicit def jsonWritesCommonCustomerInvoice: play.api.libs.json.Writes[CustomerInvoice] = {
      (obj: io.flow.common.v0.models.CustomerInvoice) => {
        io.flow.common.v0.models.json.jsObjectCustomerInvoice(obj)
      }
    }

    implicit def jsonReadsCommonCustomerReference: play.api.libs.json.Reads[io.flow.common.v0.models.CustomerReference] = {
      (__ \ "number").read[String].map { x => CustomerReference(number = x) }
    }
    ...
    implicit def jsonWritesCommonCustomerReference: play.api.libs.json.Writes[CustomerReference] = {
      (obj: io.flow.common.v0.models.CustomerReference) => {
        io.flow.common.v0.models.json.jsObjectCustomerReference(obj)
      }
    }

    implicit def jsonReadsCommonDatetimeRange: play.api.libs.json.Reads[io.flow.common.v0.models.DatetimeRange] = {
      for {
    ...
    implicit def jsonWritesCommonDatetimeRange: play.api.libs.json.Writes[DatetimeRange] = {
      (obj: io.flow.common.v0.models.DatetimeRange) => {
        io.flow.common.v0.models.json.jsObjectDatetimeRange(obj)
      }
    }

    implicit def jsonReadsCommonDimension: play.api.libs.json.Reads[io.flow.common.v0.models.Dimension] = {
      for {
    ...
    def jsObjectDimension(obj: io.flow.common.v0.models.Dimension): play.api.libs.json.JsObject = {
      (obj.depth match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("depth" -> io.flow.common.v0.models.json.jsObjectMeasurement(x))
      }) ++
      (obj.diameter match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("diameter" -> io.flow.common.v0.models.json.jsObjectMeasurement(x))
      }) ++
      (obj.length match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("length" -> io.flow.common.v0.models.json.jsObjectMeasurement(x))
      }) ++
      (obj.weight match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("weight" -> io.flow.common.v0.models.json.jsObjectMeasurement(x))
      }) ++
      (obj.width match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("width" -> io.flow.common.v0.models.json.jsObjectMeasurement(x))
      })
    }

    implicit def jsonWritesCommonDimension: play.api.libs.json.Writes[Dimension] = {
      (obj: io.flow.common.v0.models.Dimension) => {
        io.flow.common.v0.models.json.jsObjectDimension(obj)
      }
    }

    implicit def jsonReadsCommonDimensions: play.api.libs.json.Reads[io.flow.common.v0.models.Dimensions] = {
      for {
    ...
    def jsObjectDimensions(obj: io.flow.common.v0.models.Dimensions): play.api.libs.json.JsObject = {
      (obj.product match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("product" -> io.flow.common.v0.models.json.jsObjectDimension(x))
      }) ++
      (obj.packaging match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("packaging" -> io.flow.common.v0.models.json.jsObjectDimension(x))
      })
    }

    implicit def jsonWritesCommonDimensions: play.api.libs.json.Writes[Dimensions] = {
      (obj: io.flow.common.v0.models.Dimensions) => {
        io.flow.common.v0.models.json.jsObjectDimensions(obj)
      }
    }

    implicit def jsonReadsCommonDiscountForm: play.api.libs.json.Reads[io.flow.common.v0.models.DiscountForm] = {
      for {
    ...
    def jsObjectDiscountForm(obj: io.flow.common.v0.models.DiscountForm): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "offer" -> io.flow.common.v0.models.json.jsObjectDiscountOffer(obj.offer),
    ...
    implicit def jsonWritesCommonDiscountForm: play.api.libs.json.Writes[DiscountForm] = {
      (obj: io.flow.common.v0.models.DiscountForm) => {
        io.flow.common.v0.models.json.jsObjectDiscountForm(obj)
      }
    }

    implicit def jsonReadsCommonDiscountOfferFixed: play.api.libs.json.Reads[io.flow.common.v0.models.DiscountOfferFixed] = {
      (__ \ "money").read[io.flow.common.v0.models.Money].map { x => DiscountOfferFixed(money = x) }
    }

    def jsObjectDiscountOfferFixed(obj: io.flow.common.v0.models.DiscountOfferFixed): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "money" -> io.flow.common.v0.models.json.jsObjectMoney(obj.money)
    ...
    implicit def jsonWritesCommonDiscountOfferFixed: play.api.libs.json.Writes[DiscountOfferFixed] = {
      (obj: io.flow.common.v0.models.DiscountOfferFixed) => {
        io.flow.common.v0.models.json.jsObjectDiscountOfferFixed(obj)
      }
    }

    implicit def jsonReadsCommonDiscountOfferPercent: play.api.libs.json.Reads[io.flow.common.v0.models.DiscountOfferPercent] = {
      (__ \ "percent").read[BigDecimal].map { x => DiscountOfferPercent(percent = x) }
    }
    ...
    implicit def jsonWritesCommonDiscountOfferPercent: play.api.libs.json.Writes[DiscountOfferPercent] = {
      (obj: io.flow.common.v0.models.DiscountOfferPercent) => {
        io.flow.common.v0.models.json.jsObjectDiscountOfferPercent(obj)
      }
    }

    implicit def jsonReadsCommonDiscountsForm: play.api.libs.json.Reads[io.flow.common.v0.models.DiscountsForm] = {
      (__ \ "discounts").read[Seq[io.flow.common.v0.models.DiscountForm]].map { x => DiscountsForm(discounts = x) }
    }
    ...
    implicit def jsonWritesCommonDiscountsForm: play.api.libs.json.Writes[DiscountsForm] = {
      (obj: io.flow.common.v0.models.DiscountsForm) => {
        io.flow.common.v0.models.json.jsObjectDiscountsForm(obj)
      }
    }

    implicit def jsonReadsCommonDuration: play.api.libs.json.Reads[io.flow.common.v0.models.Duration] = {
      for {
    ...
    implicit def jsonWritesCommonDuration: play.api.libs.json.Writes[Duration] = {
      (obj: io.flow.common.v0.models.Duration) => {
        io.flow.common.v0.models.json.jsObjectDuration(obj)
      }
    }

    implicit def jsonReadsCommonEntityIdentifier: play.api.libs.json.Reads[io.flow.common.v0.models.EntityIdentifier] = {
      for {
        name <- (__ \ "name").read[io.flow.common.v0.models.EntityIdentifierType]
        number <- (__ \ "number").read[String]
        issuingCountry <- (__ \ "issuing_country").readNullable[String]
      } yield EntityIdentifier(name, number, issuingCountry)
    }

    def jsObjectEntityIdentifier(obj: io.flow.common.v0.models.EntityIdentifier): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "name" -> play.api.libs.json.JsString(obj.name.toString),
        "number" -> play.api.libs.json.JsString(obj.number)
      ) ++ (obj.issuingCountry match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("issuing_country" -> play.api.libs.json.JsString(x))
      })
    }

    implicit def jsonWritesCommonEntityIdentifier: play.api.libs.json.Writes[EntityIdentifier] = {
      (obj: io.flow.common.v0.models.EntityIdentifier) => {
        io.flow.common.v0.models.json.jsObjectEntityIdentifier(obj)
      }
    }

    implicit def jsonReadsCommonException: play.api.libs.json.Reads[io.flow.common.v0.models.Exception] = {
      for {
    ...
    def jsObjectException(obj: io.flow.common.v0.models.Exception): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "datetime_range" -> io.flow.common.v0.models.json.jsObjectDatetimeRange(obj.datetimeRange)
      )
    }

    implicit def jsonWritesCommonException: play.api.libs.json.Writes[Exception] = {
      (obj: io.flow.common.v0.models.Exception) => {
        io.flow.common.v0.models.json.jsObjectException(obj)
      }
    }

    implicit def jsonReadsCommonExperienceSummary: play.api.libs.json.Reads[io.flow.common.v0.models.ExperienceSummary] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    implicit def jsonWritesCommonExperienceSummary: play.api.libs.json.Writes[ExperienceSummary] = {
      (obj: io.flow.common.v0.models.ExperienceSummary) => {
        io.flow.common.v0.models.json.jsObjectExperienceSummary(obj)
      }
    }

    implicit def jsonReadsCommonIncludedLevies: play.api.libs.json.Reads[io.flow.common.v0.models.IncludedLevies] = {
      for {
    ...
    implicit def jsonWritesCommonIncludedLevies: play.api.libs.json.Writes[IncludedLevies] = {
      (obj: io.flow.common.v0.models.IncludedLevies) => {
        io.flow.common.v0.models.json.jsObjectIncludedLevies(obj)
      }
    }

    implicit def jsonReadsCommonInputForm: play.api.libs.json.Reads[io.flow.common.v0.models.InputForm] = {
      (__ \ "values").readNullable[Map[String, String]].map { x => InputForm(values = x) }
    }
    ...
    implicit def jsonWritesCommonInputForm: play.api.libs.json.Writes[InputForm] = {
      (obj: io.flow.common.v0.models.InputForm) => {
        io.flow.common.v0.models.json.jsObjectInputForm(obj)
      }
    }

    implicit def jsonReadsCommonInputFormSpecification: play.api.libs.json.Reads[io.flow.common.v0.models.InputFormSpecification] = {
      for {
    ...
    def jsObjectInputFormSpecification(obj: io.flow.common.v0.models.InputFormSpecification): play.api.libs.json.JsObject = {
      ...
      (obj.limitations match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("limitations" -> io.flow.common.v0.models.json.jsObjectInputSpecificationLimitations(x))
      })
    }

    implicit def jsonWritesCommonInputFormSpecification: play.api.libs.json.Writes[InputFormSpecification] = {
      (obj: io.flow.common.v0.models.InputFormSpecification) => {
        io.flow.common.v0.models.json.jsObjectInputFormSpecification(obj)
      }
    }

    implicit def jsonReadsCommonInputSpecification: play.api.libs.json.Reads[io.flow.common.v0.models.InputSpecification] = {
      for {
    ...
    implicit def jsonWritesCommonInputSpecification: play.api.libs.json.Writes[InputSpecification] = {
      (obj: io.flow.common.v0.models.InputSpecification) => {
        io.flow.common.v0.models.json.jsObjectInputSpecification(obj)
      }
    }

    implicit def jsonReadsCommonInputSpecificationLimitationMax: play.api.libs.json.Reads[io.flow.common.v0.models.InputSpecificationLimitationMax] = {
      (__ \ "max").read[Long].map { x => InputSpecificationLimitationMax(max = x) }
    }
    ...
    implicit def jsonWritesCommonInputSpecificationLimitationMax: play.api.libs.json.Writes[InputSpecificationLimitationMax] = {
      (obj: io.flow.common.v0.models.InputSpecificationLimitationMax) => {
        io.flow.common.v0.models.json.jsObjectInputSpecificationLimitationMax(obj)
      }
    }

    implicit def jsonReadsCommonInputSpecificationLimitations: play.api.libs.json.Reads[io.flow.common.v0.models.InputSpecificationLimitations] = {
      (__ \ "limitations").readNullable[Seq[io.flow.common.v0.models.InputSpecificationLimitation]].map { x => InputSpecificationLimitations(limitations = x) }
    }
    ...
    implicit def jsonWritesCommonInputSpecificationLimitations: play.api.libs.json.Writes[InputSpecificationLimitations] = {
      (obj: io.flow.common.v0.models.InputSpecificationLimitations) => {
        io.flow.common.v0.models.json.jsObjectInputSpecificationLimitations(obj)
      }
    }

    implicit def jsonReadsCommonItemReference: play.api.libs.json.Reads[io.flow.common.v0.models.ItemReference] = {
      (__ \ "number").read[String].map { x => ItemReference(number = x) }
    }
    ...
    implicit def jsonWritesCommonItemReference: play.api.libs.json.Writes[ItemReference] = {
      (obj: io.flow.common.v0.models.ItemReference) => {
        io.flow.common.v0.models.json.jsObjectItemReference(obj)
      }
    }

    implicit def jsonReadsCommonLineItem: play.api.libs.json.Reads[io.flow.common.v0.models.LineItem] = {
      for {
        number <- (__ \ "number").read[String]
    ...
    implicit def jsonWritesCommonLineItem: play.api.libs.json.Writes[LineItem] = {
      (obj: io.flow.common.v0.models.LineItem) => {
        io.flow.common.v0.models.json.jsObjectLineItem(obj)
      }
    }

    implicit def jsonReadsCommonLineItemAttributesForm: play.api.libs.json.Reads[io.flow.common.v0.models.LineItemAttributesForm] = {
      (__ \ "attributes").read[Map[String, String]].map { x => LineItemAttributesForm(attributes = x) }
    }
    ...
    implicit def jsonWritesCommonLineItemAttributesForm: play.api.libs.json.Writes[LineItemAttributesForm] = {
      (obj: io.flow.common.v0.models.LineItemAttributesForm) => {
        io.flow.common.v0.models.json.jsObjectLineItemAttributesForm(obj)
      }
    }

    implicit def jsonReadsCommonLineItemForm: play.api.libs.json.Reads[io.flow.common.v0.models.LineItemForm] = {
      for {
        number <- (__ \ "number").read[String]
        quantity <- (__ \ "quantity").read[Long]
    ...
    implicit def jsonWritesCommonLineItemForm: play.api.libs.json.Writes[LineItemForm] = {
      (obj: io.flow.common.v0.models.LineItemForm) => {
        io.flow.common.v0.models.json.jsObjectLineItemForm(obj)
      }
    }

    implicit def jsonReadsCommonLineItemQuantityForm: play.api.libs.json.Reads[io.flow.common.v0.models.LineItemQuantityForm] = {
      (__ \ "quantity").read[Long].map { x => LineItemQuantityForm(quantity = x) }
    }
    ...
    implicit def jsonWritesCommonLineItemQuantityForm: play.api.libs.json.Writes[LineItemQuantityForm] = {
      (obj: io.flow.common.v0.models.LineItemQuantityForm) => {
        io.flow.common.v0.models.json.jsObjectLineItemQuantityForm(obj)
      }
    }

    implicit def jsonReadsCommonLogoImageSetStatic: play.api.libs.json.Reads[io.flow.common.v0.models.LogoImageSetStatic] = {
      for {
        small <- (__ \ "small").readNullable[io.flow.common.v0.models.LogoImageStatic]
        medium <- (__ \ "medium").read[io.flow.common.v0.models.LogoImageStatic]
        large <- (__ \ "large").readNullable[io.flow.common.v0.models.LogoImageStatic]
      } yield LogoImageSetStatic(small, medium, large)
    }

    def jsObjectLogoImageSetStatic(obj: io.flow.common.v0.models.LogoImageSetStatic): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "medium" -> io.flow.common.v0.models.json.jsObjectLogoImageStatic(obj.medium)
      ) ++ (obj.small match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("small" -> io.flow.common.v0.models.json.jsObjectLogoImageStatic(x))
      }) ++
      (obj.large match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("large" -> io.flow.common.v0.models.json.jsObjectLogoImageStatic(x))
      }) ++ play.api.libs.json.Json.obj("discriminator" -> "static")
    }

    implicit def jsonWritesCommonLogoImageSetStatic: play.api.libs.json.Writes[LogoImageSetStatic] = {
      (obj: io.flow.common.v0.models.LogoImageSetStatic) => {
        io.flow.common.v0.models.json.jsObjectLogoImageSetStatic(obj)
      }
    }

    implicit def jsonReadsCommonLogoImageStatic: play.api.libs.json.Reads[io.flow.common.v0.models.LogoImageStatic] = {
      for {
        url <- (__ \ "url").read[String]
        width <- (__ \ "width").read[Int]
        height <- (__ \ "height").read[Int]
      } yield LogoImageStatic(url, width, height)
    }

    def jsObjectLogoImageStatic(obj: io.flow.common.v0.models.LogoImageStatic): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesCommonLogoImageStatic: play.api.libs.json.Writes[LogoImageStatic] = {
      (obj: io.flow.common.v0.models.LogoImageStatic) => {
        io.flow.common.v0.models.json.jsObjectLogoImageStatic(obj)
      }
    }

    implicit def jsonReadsCommonLogoImageSvg: play.api.libs.json.Reads[io.flow.common.v0.models.LogoImageSvg] = {
      (__ \ "url").read[String].map { x => LogoImageSvg(url = x) }
    }

    def jsObjectLogoImageSvg(obj: io.flow.common.v0.models.LogoImageSvg): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "url" -> play.api.libs.json.JsString(obj.url)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "svg")
    }

    implicit def jsonWritesCommonLogoImageSvg: play.api.libs.json.Writes[LogoImageSvg] = {
      (obj: io.flow.common.v0.models.LogoImageSvg) => {
        io.flow.common.v0.models.json.jsObjectLogoImageSvg(obj)
      }
    }

    implicit def jsonReadsCommonMargin: play.api.libs.json.Reads[io.flow.common.v0.models.Margin] = {
      for {
    ...
    implicit def jsonWritesCommonMargin: play.api.libs.json.Writes[Margin] = {
      (obj: io.flow.common.v0.models.Margin) => {
        io.flow.common.v0.models.json.jsObjectMargin(obj)
      }
    }

    implicit def jsonReadsCommonMeasurement: play.api.libs.json.Reads[io.flow.common.v0.models.Measurement] = {
      for {
    ...
    implicit def jsonWritesCommonMeasurement: play.api.libs.json.Writes[Measurement] = {
      (obj: io.flow.common.v0.models.Measurement) => {
        io.flow.common.v0.models.json.jsObjectMeasurement(obj)
      }
    }

    implicit def jsonReadsCommonMerchantOfRecordEntity: play.api.libs.json.Reads[io.flow.common.v0.models.MerchantOfRecordEntity] = {
      for {
        organization <- (__ \ "organization").read[io.flow.common.v0.models.OrganizationReference]
        name <- (__ \ "name").read[String]
        vat <- (__ \ "vat").readNullable[io.flow.common.v0.models.MerchantOfRecordEntityRegistration]
        identifiers <- (__ \ "identifiers").readNullable[Seq[io.flow.common.v0.models.EntityIdentifier]]
        ...
        phone <- (__ \ "phone").readNullable[String]
        email <- (__ \ "email").readNullable[String]
      } yield MerchantOfRecordEntity(organization, name, vat, identifiers, streets, city, province, postal, country, phone, email)
    }
    ...
    def jsObjectMerchantOfRecordEntity(obj: io.flow.common.v0.models.MerchantOfRecordEntity): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("vat" -> io.flow.common.v0.models.json.jsObjectMerchantOfRecordEntityRegistration(x))
      }) ++
    ...
    implicit def jsonWritesCommonMerchantOfRecordEntity: play.api.libs.json.Writes[MerchantOfRecordEntity] = {
      (obj: io.flow.common.v0.models.MerchantOfRecordEntity) => {
        io.flow.common.v0.models.json.jsObjectMerchantOfRecordEntity(obj)
      }
    }

    implicit def jsonReadsCommonMerchantOfRecordEntityRegistration: play.api.libs.json.Reads[io.flow.common.v0.models.MerchantOfRecordEntityRegistration] = {
      for {
        number <- (__ \ "number").read[String]
        country <- (__ \ "country").read[String]
    ...
    implicit def jsonWritesCommonMerchantOfRecordEntityRegistration: play.api.libs.json.Writes[MerchantOfRecordEntityRegistration] = {
      (obj: io.flow.common.v0.models.MerchantOfRecordEntityRegistration) => {
        io.flow.common.v0.models.json.jsObjectMerchantOfRecordEntityRegistration(obj)
      }
    }

    implicit def jsonReadsCommonMoney: play.api.libs.json.Reads[io.flow.common.v0.models.Money] = {
      for {
    ...
    implicit def jsonWritesCommonMoney: play.api.libs.json.Writes[Money] = {
      (obj: io.flow.common.v0.models.Money) => {
        io.flow.common.v0.models.json.jsObjectMoney(obj)
      }
    }

    implicit def jsonReadsCommonMoneyWithBase: play.api.libs.json.Reads[io.flow.common.v0.models.MoneyWithBase] = {
      for {
        currency <- (__ \ "currency").read[String]
        amount <- (__ \ "amount").read[Double]
    ...
    implicit def jsonWritesCommonMoneyWithBase: play.api.libs.json.Writes[MoneyWithBase] = {
      (obj: io.flow.common.v0.models.MoneyWithBase) => {
        io.flow.common.v0.models.json.jsObjectMoneyWithBase(obj)
      }
    }

    implicit def jsonReadsCommonMoneyWithOptionalBase: play.api.libs.json.Reads[io.flow.common.v0.models.MoneyWithOptionalBase] = {
      for {
        currency <- (__ \ "currency").read[String]
        amount <- (__ \ "amount").read[Double]
    ...
    implicit def jsonWritesCommonMoneyWithOptionalBase: play.api.libs.json.Writes[MoneyWithOptionalBase] = {
      (obj: io.flow.common.v0.models.MoneyWithOptionalBase) => {
        io.flow.common.v0.models.json.jsObjectMoneyWithOptionalBase(obj)
      }
    }

    implicit def jsonReadsCommonName: play.api.libs.json.Reads[io.flow.common.v0.models.Name] = {
      for {
    ...
    implicit def jsonWritesCommonName: play.api.libs.json.Writes[Name] = {
      (obj: io.flow.common.v0.models.Name) => {
        io.flow.common.v0.models.json.jsObjectName(obj)
      }
    }

    implicit def jsonReadsCommonOrderCustomer: play.api.libs.json.Reads[io.flow.common.v0.models.OrderCustomer] = {
      for {
        name <- (__ \ "name").read[io.flow.common.v0.models.Name]
    ...
    def jsObjectOrderCustomer(obj: io.flow.common.v0.models.OrderCustomer): play.api.libs.json.JsObject = {
      ...
      (obj.invoice match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("invoice" -> io.flow.common.v0.models.json.jsObjectCustomerInvoice(x))
      })
    }

    implicit def jsonWritesCommonOrderCustomer: play.api.libs.json.Writes[OrderCustomer] = {
      (obj: io.flow.common.v0.models.OrderCustomer) => {
        io.flow.common.v0.models.json.jsObjectOrderCustomer(obj)
      }
    }

    implicit def jsonReadsCommonOrderCustomerForm: play.api.libs.json.Reads[io.flow.common.v0.models.OrderCustomerForm] = {
      for {
        name <- (__ \ "name").readNullable[io.flow.common.v0.models.Name]
        number <- (__ \ "number").readNullable[String]
        phone <- (__ \ "phone").readNullable[String]
    ...
    implicit def jsonWritesCommonOrderCustomerForm: play.api.libs.json.Writes[OrderCustomerForm] = {
      (obj: io.flow.common.v0.models.OrderCustomerForm) => {
        io.flow.common.v0.models.json.jsObjectOrderCustomerForm(obj)
      }
    }

    implicit def jsonReadsCommonOrganization: play.api.libs.json.Reads[io.flow.common.v0.models.Organization] = {
      for {
        id <- (__ \ "id").read[String]
        name <- (__ \ "name").read[String]
        ...
        `type` <- (__ \ "type").readNullable[io.flow.common.v0.models.OrganizationType]
      } yield Organization(id, name, environment, parent, defaults, createdAt, status, `type`)
    }
    ...
    def jsObjectOrganization(obj: io.flow.common.v0.models.Organization): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("parent" -> io.flow.common.v0.models.json.jsObjectOrganizationReference(x))
      }) ++
      (obj.defaults match {
        case None => play.api.libs.json.Json.obj()
    ...
    implicit def jsonWritesCommonOrganization: play.api.libs.json.Writes[Organization] = {
      (obj: io.flow.common.v0.models.Organization) => {
        io.flow.common.v0.models.json.jsObjectOrganization(obj)
      }
    }

    implicit def jsonReadsCommonOrganizationDefaults: play.api.libs.json.Reads[io.flow.common.v0.models.OrganizationDefaults] = {
      for {
        country <- (__ \ "country").read[String]
    ...
    implicit def jsonWritesCommonOrganizationDefaults: play.api.libs.json.Writes[OrganizationDefaults] = {
      (obj: io.flow.common.v0.models.OrganizationDefaults) => {
        io.flow.common.v0.models.json.jsObjectOrganizationDefaults(obj)
      }
    }

    implicit def jsonReadsCommonOrganizationReference: play.api.libs.json.Reads[io.flow.common.v0.models.OrganizationReference] = {
      (__ \ "id").read[String].map { x => OrganizationReference(id = x) }
    }
    ...
    implicit def jsonWritesCommonOrganizationReference: play.api.libs.json.Writes[OrganizationReference] = {
      (obj: io.flow.common.v0.models.OrganizationReference) => {
        io.flow.common.v0.models.json.jsObjectOrganizationReference(obj)
      }
    }

    implicit def jsonReadsCommonOrganizationSummary: play.api.libs.json.Reads[io.flow.common.v0.models.OrganizationSummary] = {
      for {
        id <- (__ \ "id").read[String]
        name <- (__ \ "name").read[String]
        environment <- (__ \ "environment").read[io.flow.common.v0.models.Environment]
      } yield OrganizationSummary(id, name, environment)
    }
    ...
    implicit def jsonWritesCommonOrganizationSummary: play.api.libs.json.Writes[OrganizationSummary] = {
      (obj: io.flow.common.v0.models.OrganizationSummary) => {
        io.flow.common.v0.models.json.jsObjectOrganizationSummary(obj)
      }
    }

    implicit def jsonReadsCommonPartnerReference: play.api.libs.json.Reads[io.flow.common.v0.models.PartnerReference] = {
      (__ \ "id").read[String].map { x => PartnerReference(id = x) }
    }
    ...
    implicit def jsonWritesCommonPartnerReference: play.api.libs.json.Writes[PartnerReference] = {
      (obj: io.flow.common.v0.models.PartnerReference) => {
        io.flow.common.v0.models.json.jsObjectPartnerReference(obj)
      }
    }

    implicit def jsonReadsCommonPrice: play.api.libs.json.Reads[io.flow.common.v0.models.Price] = {
      for {
        amount <- (__ \ "amount").read[Double]
        currency <- (__ \ "currency").read[String]
        label <- (__ \ "label").read[String]
    ...
    implicit def jsonWritesCommonPrice: play.api.libs.json.Writes[Price] = {
      (obj: io.flow.common.v0.models.Price) => {
        io.flow.common.v0.models.json.jsObjectPrice(obj)
      }
    }

    implicit def jsonReadsCommonPriceForm: play.api.libs.json.Reads[io.flow.common.v0.models.PriceForm] = {
      for {
        amount <- (__ \ "amount").read[Double]
        currency <- (__ \ "currency").read[String]
    ...
    implicit def jsonWritesCommonPriceForm: play.api.libs.json.Writes[PriceForm] = {
      (obj: io.flow.common.v0.models.PriceForm) => {
        io.flow.common.v0.models.json.jsObjectPriceForm(obj)
      }
    }

    implicit def jsonReadsCommonPriceSourceCatalog: play.api.libs.json.Reads[io.flow.common.v0.models.PriceSourceCatalog] = {
      (__ \ "price").read[io.flow.common.v0.models.Money].map { x => PriceSourceCatalog(price = x) }
    }
    ...
    implicit def jsonWritesCommonPriceSourceCatalog: play.api.libs.json.Writes[PriceSourceCatalog] = {
      (obj: io.flow.common.v0.models.PriceSourceCatalog) => {
        io.flow.common.v0.models.json.jsObjectPriceSourceCatalog(obj)
      }
    }

    implicit def jsonReadsCommonPriceSourcePriceBook: play.api.libs.json.Reads[io.flow.common.v0.models.PriceSourcePriceBook] = {
      for {
        price <- (__ \ "price").read[io.flow.common.v0.models.Money]
    ...
    def jsObjectPriceSourcePriceBook(obj: io.flow.common.v0.models.PriceSourcePriceBook): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "price_book_reference" -> io.flow.common.v0.models.json.jsObjectPriceSourcePriceBookReference(obj.priceBookReference)
    ...
    implicit def jsonWritesCommonPriceSourcePriceBook: play.api.libs.json.Writes[PriceSourcePriceBook] = {
      (obj: io.flow.common.v0.models.PriceSourcePriceBook) => {
        io.flow.common.v0.models.json.jsObjectPriceSourcePriceBook(obj)
      }
    }

    implicit def jsonReadsCommonPriceSourcePriceBookReference: play.api.libs.json.Reads[io.flow.common.v0.models.PriceSourcePriceBookReference] = {
      for {
        id <- (__ \ "id").read[String]
        key <- (__ \ "key").read[String]
    ...
    implicit def jsonWritesCommonPriceSourcePriceBookReference: play.api.libs.json.Writes[PriceSourcePriceBookReference] = {
      (obj: io.flow.common.v0.models.PriceSourcePriceBookReference) => {
        io.flow.common.v0.models.json.jsObjectPriceSourcePriceBookReference(obj)
      }
    }

    implicit def jsonReadsCommonPriceSourceProvided: play.api.libs.json.Reads[io.flow.common.v0.models.PriceSourceProvided] = {
      (__ \ "price").read[io.flow.common.v0.models.Money].map { x => PriceSourceProvided(price = x) }
    }
    ...
    implicit def jsonWritesCommonPriceSourceProvided: play.api.libs.json.Writes[PriceSourceProvided] = {
      (obj: io.flow.common.v0.models.PriceSourceProvided) => {
        io.flow.common.v0.models.json.jsObjectPriceSourceProvided(obj)
      }
    }

    implicit def jsonReadsCommonPriceWithBase: play.api.libs.json.Reads[io.flow.common.v0.models.PriceWithBase] = {
      for {
        currency <- (__ \ "currency").read[String]
        amount <- (__ \ "amount").read[Double]
        label <- (__ \ "label").read[String]
    ...
    implicit def jsonWritesCommonPriceWithBase: play.api.libs.json.Writes[PriceWithBase] = {
      (obj: io.flow.common.v0.models.PriceWithBase) => {
        io.flow.common.v0.models.json.jsObjectPriceWithBase(obj)
      }
    }

    implicit def jsonReadsCommonRepeatDaily: play.api.libs.json.Reads[io.flow.common.v0.models.RepeatDaily] = {
      (__ \ "interval").read[Int].map { x => RepeatDaily(interval = x) }
    }
    ...
    implicit def jsonWritesCommonRepeatDaily: play.api.libs.json.Writes[RepeatDaily] = {
      (obj: io.flow.common.v0.models.RepeatDaily) => {
        io.flow.common.v0.models.json.jsObjectRepeatDaily(obj)
      }
    }

    implicit def jsonReadsCommonRepeatHourly: play.api.libs.json.Reads[io.flow.common.v0.models.RepeatHourly] = {
      (__ \ "interval").read[Int].map { x => RepeatHourly(interval = x) }
    }
    ...
    implicit def jsonWritesCommonRepeatHourly: play.api.libs.json.Writes[RepeatHourly] = {
      (obj: io.flow.common.v0.models.RepeatHourly) => {
        io.flow.common.v0.models.json.jsObjectRepeatHourly(obj)
      }
    }

    implicit def jsonReadsCommonRepeatMonthly: play.api.libs.json.Reads[io.flow.common.v0.models.RepeatMonthly] = {
      for {
    ...
    implicit def jsonWritesCommonRepeatMonthly: play.api.libs.json.Writes[RepeatMonthly] = {
      (obj: io.flow.common.v0.models.RepeatMonthly) => {
        io.flow.common.v0.models.json.jsObjectRepeatMonthly(obj)
      }
    }

    implicit def jsonReadsCommonRepeatWeekly: play.api.libs.json.Reads[io.flow.common.v0.models.RepeatWeekly] = {
      for {
        interval <- (__ \ "interval").read[Int]
    ...
    implicit def jsonWritesCommonRepeatWeekly: play.api.libs.json.Writes[RepeatWeekly] = {
      (obj: io.flow.common.v0.models.RepeatWeekly) => {
        io.flow.common.v0.models.json.jsObjectRepeatWeekly(obj)
      }
    }

    implicit def jsonReadsCommonRounding: play.api.libs.json.Reads[io.flow.common.v0.models.Rounding] = {
      for {
    ...
    implicit def jsonWritesCommonRounding: play.api.libs.json.Writes[Rounding] = {
      (obj: io.flow.common.v0.models.Rounding) => {
        io.flow.common.v0.models.json.jsObjectRounding(obj)
      }
    }

    implicit def jsonReadsCommonSchedule: play.api.libs.json.Reads[io.flow.common.v0.models.Schedule] = {
      for {
    ...
    implicit def jsonWritesCommonSchedule: play.api.libs.json.Writes[Schedule] = {
      (obj: io.flow.common.v0.models.Schedule) => {
        io.flow.common.v0.models.json.jsObjectSchedule(obj)
      }
    }

    implicit def jsonReadsCommonSessionReference: play.api.libs.json.Reads[io.flow.common.v0.models.SessionReference] = {
      (__ \ "id").read[String].map { x => SessionReference(id = x) }
    }
    ...
    implicit def jsonWritesCommonSessionReference: play.api.libs.json.Writes[SessionReference] = {
      (obj: io.flow.common.v0.models.SessionReference) => {
        io.flow.common.v0.models.json.jsObjectSessionReference(obj)
      }
    }

    implicit def jsonReadsCommonUser: play.api.libs.json.Reads[io.flow.common.v0.models.User] = {
      for {
        id <- (__ \ "id").read[String]
        email <- (__ \ "email").readNullable[String]
        name <- (__ \ "name").read[io.flow.common.v0.models.Name]
    ...
    implicit def jsonWritesCommonUser: play.api.libs.json.Writes[User] = {
      (obj: io.flow.common.v0.models.User) => {
        io.flow.common.v0.models.json.jsObjectUser(obj)
      }
    }

    implicit def jsonReadsCommonUserReference: play.api.libs.json.Reads[io.flow.common.v0.models.UserReference] = {
      (__ \ "id").read[String].map { x => UserReference(id = x) }
    }
    ...
    implicit def jsonWritesCommonUserReference: play.api.libs.json.Writes[UserReference] = {
      (obj: io.flow.common.v0.models.UserReference) => {
        io.flow.common.v0.models.json.jsObjectUserReference(obj)
      }
    }

    implicit def jsonReadsCommonZone: play.api.libs.json.Reads[io.flow.common.v0.models.Zone] = {
      for {
    ...
    implicit def jsonWritesCommonZone: play.api.libs.json.Writes[Zone] = {
      (obj: io.flow.common.v0.models.Zone) => {
        io.flow.common.v0.models.json.jsObjectZone(obj)
      }
    }

    implicit def jsonReadsCommonDiscountOffer: play.api.libs.json.Reads[io.flow.common.v0.models.DiscountOffer] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "discount_offer_fixed" => io.flow.common.v0.models.json.jsonReadsCommonDiscountOfferFixed.reads(js)
          case "discount_offer_percent" => io.flow.common.v0.models.json.jsonReadsCommonDiscountOfferPercent.reads(js)
    ...
    def jsObjectDiscountOffer(obj: io.flow.common.v0.models.DiscountOffer): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.DiscountOfferFixed => io.flow.common.v0.models.json.jsObjectDiscountOfferFixed(x)
        case x: io.flow.common.v0.models.DiscountOfferPercent => io.flow.common.v0.models.json.jsObjectDiscountOfferPercent(x)
        case other => {
    ...
    implicit def jsonWritesCommonDiscountOffer: play.api.libs.json.Writes[DiscountOffer] = {
      (obj: io.flow.common.v0.models.DiscountOffer) => {
        io.flow.common.v0.models.json.jsObjectDiscountOffer(obj)
      }
    }

    implicit def jsonReadsCommonExpandableOrganization: play.api.libs.json.Reads[io.flow.common.v0.models.ExpandableOrganization] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "organization" => io.flow.common.v0.models.json.jsonReadsCommonOrganization.reads(js)
          case "organization_reference" => io.flow.common.v0.models.json.jsonReadsCommonOrganizationReference.reads(js)
    ...
    def jsObjectExpandableOrganization(obj: io.flow.common.v0.models.ExpandableOrganization): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.Organization => io.flow.common.v0.models.json.jsObjectOrganization(x)
        case x: io.flow.common.v0.models.OrganizationReference => io.flow.common.v0.models.json.jsObjectOrganizationReference(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesCommonExpandableOrganization: play.api.libs.json.Writes[ExpandableOrganization] = {
      (obj: io.flow.common.v0.models.ExpandableOrganization) => {
        io.flow.common.v0.models.json.jsObjectExpandableOrganization(obj)
      }
    }

    implicit def jsonReadsCommonExpandableUser: play.api.libs.json.Reads[io.flow.common.v0.models.ExpandableUser] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "user" => io.flow.common.v0.models.json.jsonReadsCommonUser.reads(js)
          case "user_reference" => io.flow.common.v0.models.json.jsonReadsCommonUserReference.reads(js)
    ...
    def jsObjectExpandableUser(obj: io.flow.common.v0.models.ExpandableUser): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.User => io.flow.common.v0.models.json.jsObjectUser(x)
        case x: io.flow.common.v0.models.UserReference => io.flow.common.v0.models.json.jsObjectUserReference(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesCommonExpandableUser: play.api.libs.json.Writes[ExpandableUser] = {
      (obj: io.flow.common.v0.models.ExpandableUser) => {
        io.flow.common.v0.models.json.jsObjectExpandableUser(obj)
      }
    }

    implicit def jsonReadsCommonInputSpecificationLimitation: play.api.libs.json.Reads[io.flow.common.v0.models.InputSpecificationLimitation] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "input_specification_limitation_max" => io.flow.common.v0.models.json.jsonReadsCommonInputSpecificationLimitationMax.reads(js)
    ...
    def jsObjectInputSpecificationLimitation(obj: io.flow.common.v0.models.InputSpecificationLimitation): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.InputSpecificationLimitationMax => io.flow.common.v0.models.json.jsObjectInputSpecificationLimitationMax(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesCommonInputSpecificationLimitation: play.api.libs.json.Writes[InputSpecificationLimitation] = {
      (obj: io.flow.common.v0.models.InputSpecificationLimitation) => {
        io.flow.common.v0.models.json.jsObjectInputSpecificationLimitation(obj)
      }
    }

    implicit def jsonReadsCommonLogoImage: play.api.libs.json.Reads[io.flow.common.v0.models.LogoImage] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "svg" => io.flow.common.v0.models.json.jsonReadsCommonLogoImageSvg.reads(js)
          case "static" => io.flow.common.v0.models.json.jsonReadsCommonLogoImageSetStatic.reads(js)
          case other => play.api.libs.json.JsSuccess(io.flow.common.v0.models.LogoImageUndefinedType(other))
        }
      }
      (js \ "discriminator").validate[String] match {
        case e: play.api.libs.json.JsError => e
    ...
    def jsObjectLogoImage(obj: io.flow.common.v0.models.LogoImage): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.LogoImageSvg => io.flow.common.v0.models.json.jsObjectLogoImageSvg(x)
        case x: io.flow.common.v0.models.LogoImageSetStatic => io.flow.common.v0.models.json.jsObjectLogoImageSetStatic(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    }
    implicit def jsonWritesCommonLogoImage: play.api.libs.json.Writes[LogoImage] = {
      (obj: io.flow.common.v0.models.LogoImage) => {
        io.flow.common.v0.models.json.jsObjectLogoImage(obj)
      }
    }

    implicit def jsonReadsCommonPriceSource: play.api.libs.json.Reads[io.flow.common.v0.models.PriceSource] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "price_book" => io.flow.common.v0.models.json.jsonReadsCommonPriceSourcePriceBook.reads(js)
          case "catalog" => io.flow.common.v0.models.json.jsonReadsCommonPriceSourceCatalog.reads(js)
          case "provided" => io.flow.common.v0.models.json.jsonReadsCommonPriceSourceProvided.reads(js)
    ...
    def jsObjectPriceSource(obj: io.flow.common.v0.models.PriceSource): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.PriceSourcePriceBook => io.flow.common.v0.models.json.jsObjectPriceSourcePriceBook(x)
        case x: io.flow.common.v0.models.PriceSourceCatalog => io.flow.common.v0.models.json.jsObjectPriceSourceCatalog(x)
        case x: io.flow.common.v0.models.PriceSourceProvided => io.flow.common.v0.models.json.jsObjectPriceSourceProvided(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesCommonPriceSource: play.api.libs.json.Writes[PriceSource] = {
      (obj: io.flow.common.v0.models.PriceSource) => {
        io.flow.common.v0.models.json.jsObjectPriceSource(obj)
      }
    }

    implicit def jsonReadsCommonRepeatSchedule: play.api.libs.json.Reads[io.flow.common.v0.models.RepeatSchedule] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "repeat_hourly" => io.flow.common.v0.models.json.jsonReadsCommonRepeatHourly.reads(js)
          case "repeat_daily" => io.flow.common.v0.models.json.jsonReadsCommonRepeatDaily.reads(js)
          case "repeat_weekly" => io.flow.common.v0.models.json.jsonReadsCommonRepeatWeekly.reads(js)
          case "repeat_monthly" => io.flow.common.v0.models.json.jsonReadsCommonRepeatMonthly.reads(js)
    ...
    def jsObjectRepeatSchedule(obj: io.flow.common.v0.models.RepeatSchedule): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.common.v0.models.RepeatHourly => io.flow.common.v0.models.json.jsObjectRepeatHourly(x)
        case x: io.flow.common.v0.models.RepeatDaily => io.flow.common.v0.models.json.jsObjectRepeatDaily(x)
        case x: io.flow.common.v0.models.RepeatWeekly => io.flow.common.v0.models.json.jsObjectRepeatWeekly(x)
        case x: io.flow.common.v0.models.RepeatMonthly => io.flow.common.v0.models.json.jsObjectRepeatMonthly(x)
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesCommonRepeatSchedule: play.api.libs.json.Writes[RepeatSchedule] = {
      (obj: io.flow.common.v0.models.RepeatSchedule) => {
        io.flow.common.v0.models.json.jsObjectRepeatSchedule(obj)
      }
    }
  }
}
...
package io.flow.common.v0 {
  ...
  object Bindables {
    ...
    object Models {
      ...
      val entityIdentifierTypeConverter: ApibuilderTypeConverter[io.flow.common.v0.models.EntityIdentifierType] = new ApibuilderTypeConverter[io.flow.common.v0.models.EntityIdentifierType] {
        override def convert(value: String): io.flow.common.v0.models.EntityIdentifierType = io.flow.common.v0.models.EntityIdentifierType(value)
        override def convert(value: io.flow.common.v0.models.EntityIdentifierType): String = value.toString
        override def example: io.flow.common.v0.models.EntityIdentifierType = io.flow.common.v0.models.EntityIdentifierType.Ioss
        override def validValues: Seq[io.flow.common.v0.models.EntityIdentifierType] = io.flow.common.v0.models.EntityIdentifierType.all
      }
      implicit def pathBindableEntityIdentifierType(implicit stringBinder: QueryStringBindable[String]): PathBindable[io.flow.common.v0.models.EntityIdentifierType] = ApibuilderPathBindable(entityIdentifierTypeConverter)
      implicit def queryStringBindableEntityIdentifierType(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[io.flow.common.v0.models.EntityIdentifierType] = ApibuilderQueryStringBindable(entityIdentifierTypeConverter)
      ...
      val organizationStatusConverter: ApibuilderTypeConverter[io.flow.common.v0.models.OrganizationStatus] = new ApibuilderTypeConverter[io.flow.common.v0.models.OrganizationStatus] {
        override def convert(value: String): io.flow.common.v0.models.OrganizationStatus = io.flow.common.v0.models.OrganizationStatus(value)
        override def convert(value: io.flow.common.v0.models.OrganizationStatus): String = value.toString
        override def example: io.flow.common.v0.models.OrganizationStatus = io.flow.common.v0.models.OrganizationStatus.Active
        override def validValues: Seq[io.flow.common.v0.models.OrganizationStatus] = io.flow.common.v0.models.OrganizationStatus.all
      }
      implicit def pathBindableOrganizationStatus(implicit stringBinder: QueryStringBindable[String]): PathBindable[io.flow.common.v0.models.OrganizationStatus] = ApibuilderPathBindable(organizationStatusConverter)
      implicit def queryStringBindableOrganizationStatus(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[io.flow.common.v0.models.OrganizationStatus] = ApibuilderQueryStringBindable(organizationStatusConverter)

      val organizationTypeConverter: ApibuilderTypeConverter[io.flow.common.v0.models.OrganizationType] = new ApibuilderTypeConverter[io.flow.common.v0.models.OrganizationType] {
        override def convert(value: String): io.flow.common.v0.models.OrganizationType = io.flow.common.v0.models.OrganizationType(value)
        override def convert(value: io.flow.common.v0.models.OrganizationType): String = value.toString
        override def example: io.flow.common.v0.models.OrganizationType = io.flow.common.v0.models.OrganizationType.Standalone
        override def validValues: Seq[io.flow.common.v0.models.OrganizationType] = io.flow.common.v0.models.OrganizationType.all
      }
      implicit def pathBindableOrganizationType(implicit stringBinder: QueryStringBindable[String]): PathBindable[io.flow.common.v0.models.OrganizationType] = ApibuilderPathBindable(organizationTypeConverter)
      implicit def queryStringBindableOrganizationType(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[io.flow.common.v0.models.OrganizationType] = ApibuilderQueryStringBindable(organizationTypeConverter)
...
package io.flow.common.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/common/latest/play_2_8_client"
    val Version = "0.19.73"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private val logger = play.api.Logger("io.flow.common.v0.Client")
