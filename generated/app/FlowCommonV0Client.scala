 ...
 * apibuilder 0.14.75 app.apibuilder.io/flow/common/0.7.78/play_2_6_client
 */
package io.flow.common.v0.models {
  ...
  object RepeatScheduleDiscriminator {
    ...
    val all: scala.List[RepeatScheduleDiscriminator] = scala.List(RepeatDaily, RepeatWeekly, RepeatMonthly)
   ...
   * 
   * @param days A list of the days of the month on which to generate the monthly statement
   */
...
package io.flow.common.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.75 app.apibuilder.io/flow/common/0.7.78/play_2_6_client"
    val Version = "0.7.78"
    val VersionMajor = 0
