 ...
 * Service version: 0.4.82
 * apibuilder 0.13.0 app.apibuilder.io/flow/common/0.4.82/play_2_6_client
 */
package io.flow.common.v0.models {
  ...
  object AttributeDataType {
     ...
     * above.
     */
    val all: scala.List[AttributeDataType] = scala.List(Boolean, Decimal, String)
...
package io.flow.common.v0 {
  ...
  object Bindables {
    ...
    private[this] val enumAttributeDataTypeNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${io.flow.common.v0.models.AttributeDataType.all.mkString(", ")}"

    implicit val pathBindableEnumAttributeDataType = new PathBindable.Parsing[io.flow.common.v0.models.AttributeDataType] (
      AttributeDataType.fromString(_).get, _.toString, enumAttributeDataTypeNotFound
    )

    implicit val queryStringBindableEnumAttributeDataType = new QueryStringBindable.Parsing[io.flow.common.v0.models.AttributeDataType](
      AttributeDataType.fromString(_).get, _.toString, enumAttributeDataTypeNotFound
    )

    // Enum: AvailabilityStatus
    private[this] val enumAvailabilityStatusNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${io.flow.common.v0.models.AvailabilityStatus.all.mkString(", ")}"

    implicit val pathBindableEnumAvailabilityStatus = new PathBindable.Parsing[io.flow.common.v0.models.AvailabilityStatus] (
      AvailabilityStatus.fromString(_).get, _.toString, enumAvailabilityStatusNotFound
    )

    implicit val queryStringBindableEnumAvailabilityStatus = new QueryStringBindable.Parsing[io.flow.common.v0.models.AvailabilityStatus](
      AvailabilityStatus.fromString(_).get, _.toString, enumAvailabilityStatusNotFound
    )
    ...
    // Enum: CurrencyLabelFormatter
    private[this] val enumCurrencyLabelFormatterNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${io.flow.common.v0.models.CurrencyLabelFormatter.all.mkString(", ")}"

    implicit val pathBindableEnumCurrencyLabelFormatter = new PathBindable.Parsing[io.flow.common.v0.models.CurrencyLabelFormatter] (
      CurrencyLabelFormatter.fromString(_).get, _.toString, enumCurrencyLabelFormatterNotFound
    )

    implicit val queryStringBindableEnumCurrencyLabelFormatter = new QueryStringBindable.Parsing[io.flow.common.v0.models.CurrencyLabelFormatter](
      CurrencyLabelFormatter.fromString(_).get, _.toString, enumCurrencyLabelFormatterNotFound
    )

    // Enum: CurrencySymbolFormat
    private[this] val enumCurrencySymbolFormatNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${io.flow.common.v0.models.CurrencySymbolFormat.all.mkString(", ")}"

    implicit val pathBindableEnumCurrencySymbolFormat = new PathBindable.Parsing[io.flow.common.v0.models.CurrencySymbolFormat] (
      CurrencySymbolFormat.fromString(_).get, _.toString, enumCurrencySymbolFormatNotFound
    )

    implicit val queryStringBindableEnumCurrencySymbolFormat = new QueryStringBindable.Parsing[io.flow.common.v0.models.CurrencySymbolFormat](
      CurrencySymbolFormat.fromString(_).get, _.toString, enumCurrencySymbolFormatNotFound
    )

    // Enum: DayOfWeek
    private[this] val enumDayOfWeekNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${io.flow.common.v0.models.DayOfWeek.all.mkString(", ")}"

    implicit val pathBindableEnumDayOfWeek = new PathBindable.Parsing[io.flow.common.v0.models.DayOfWeek] (
      DayOfWeek.fromString(_).get, _.toString, enumDayOfWeekNotFound
    )

    implicit val queryStringBindableEnumDayOfWeek = new QueryStringBindable.Parsing[io.flow.common.v0.models.DayOfWeek](
      DayOfWeek.fromString(_).get, _.toString, enumDayOfWeekNotFound
    )
    ...
    // Enum: IncludedLevyKey
    private[this] val enumIncludedLevyKeyNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${io.flow.common.v0.models.IncludedLevyKey.all.mkString(", ")}"

    implicit val pathBindableEnumIncludedLevyKey = new PathBindable.Parsing[io.flow.common.v0.models.IncludedLevyKey] (
      IncludedLevyKey.fromString(_).get, _.toString, enumIncludedLevyKeyNotFound
    )

    implicit val queryStringBindableEnumIncludedLevyKey = new QueryStringBindable.Parsing[io.flow.common.v0.models.IncludedLevyKey](
      IncludedLevyKey.fromString(_).get, _.toString, enumIncludedLevyKeyNotFound
    )
    ...
    private[this] val enumPriceBookStatusNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${io.flow.common.v0.models.PriceBookStatus.all.mkString(", ")}"

    implicit val pathBindableEnumPriceBookStatus = new PathBindable.Parsing[io.flow.common.v0.models.PriceBookStatus] (
      PriceBookStatus.fromString(_).get, _.toString, enumPriceBookStatusNotFound
    )

    implicit val queryStringBindableEnumPriceBookStatus = new QueryStringBindable.Parsing[io.flow.common.v0.models.PriceBookStatus](
      PriceBookStatus.fromString(_).get, _.toString, enumPriceBookStatusNotFound
    )
    ...
    // Enum: UserStatus
    private[this] val enumUserStatusNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${io.flow.common.v0.models.UserStatus.all.mkString(", ")}"

    implicit val pathBindableEnumUserStatus = new PathBindable.Parsing[io.flow.common.v0.models.UserStatus] (
      UserStatus.fromString(_).get, _.toString, enumUserStatusNotFound
    )

    implicit val queryStringBindableEnumUserStatus = new QueryStringBindable.Parsing[io.flow.common.v0.models.UserStatus](
      UserStatus.fromString(_).get, _.toString, enumUserStatusNotFound
    )
...
package io.flow.common.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.13.0 app.apibuilder.io/flow/common/0.4.82/play_2_6_client"
    val Version = "0.4.82"
    val VersionMajor = 0
