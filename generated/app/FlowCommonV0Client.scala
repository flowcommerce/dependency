 ...
 * apibuilder 0.14.3 app.apibuilder.io/flow/common/0.6.48/play_2_6_client
 */
...
package io.flow.common.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsCommonCustomer: play.api.libs.json.Reads[Customer] = {
      ...
      } yield Customer(name, number, phone, email, address)
    }
    ...
    implicit def jsonReadsCommonOrganization: play.api.libs.json.Reads[Organization] = {
      ...
      } yield Organization(id, name, environment, parent, defaults)
    }
...
package io.flow.common.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/flow/common/0.6.48/play_2_6_client"
    val Version = "0.6.48"
    val VersionMajor = 0
