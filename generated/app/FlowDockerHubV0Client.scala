 ...
 * User agent: apibuilder app.apibuilder.io/flow/docker-hub/latest/play_2_8_client
 */
...
package io.flow.docker.hub.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsDockerHubJwt: play.api.libs.json.Reads[io.flow.docker.hub.v0.models.Jwt] = {
      (__ \ "token").read[String].map { x => Jwt(token = x) }
    }
    ...
    implicit def jsonWritesDockerHubJwt: play.api.libs.json.Writes[Jwt] = {
      (obj: io.flow.docker.hub.v0.models.Jwt) => {
        io.flow.docker.hub.v0.models.json.jsObjectJwt(obj)
      }
    }

    implicit def jsonReadsDockerHubJwtForm: play.api.libs.json.Reads[io.flow.docker.hub.v0.models.JwtForm] = {
      for {
    ...
    implicit def jsonWritesDockerHubJwtForm: play.api.libs.json.Writes[JwtForm] = {
      (obj: io.flow.docker.hub.v0.models.JwtForm) => {
        io.flow.docker.hub.v0.models.json.jsObjectJwtForm(obj)
      }
    }
  }
}
...
package io.flow.docker.hub.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/docker-hub/latest/play_2_8_client"
    val Version = "0.3.46"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private val logger = play.api.Logger("io.flow.docker.hub.v0.Client")
