 ...
 * User agent: apibuilder app.apibuilder.io/flow/error/latest/play_2_8_client
 */
package io.flow.error.v0.models {
  ...
  object GenericErrorCode {
     ...
     */
    case object GenericError extends GenericErrorCode {
      override def toString = "generic_error"
    }
    /**
     * A client error has occurred. This represents a misconfiguration of the client
     */
    case object ClientError extends GenericErrorCode {
      override def toString = "client_error"
    }
    /**
     * A server error has occurred. The Flow tech team is automatically notified of all
     * server errors
     */
    case object ServerError extends GenericErrorCode {
...
package io.flow.error.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsErrorGenericErrorCode: play.api.libs.json.Reads[io.flow.error.v0.models.GenericErrorCode] = new play.api.libs.json.Reads[io.flow.error.v0.models.GenericErrorCode] {
    ...
    implicit def jsonWritesErrorGenericErrorCode: play.api.libs.json.Writes[GenericErrorCode] = {
      (obj: io.flow.error.v0.models.GenericErrorCode) => {
        io.flow.error.v0.models.json.jsonWritesErrorGenericErrorCode(obj)
      }
    }

    implicit def jsonReadsErrorGenericError: play.api.libs.json.Reads[io.flow.error.v0.models.GenericError] = {
      for {
    ...
    implicit def jsonWritesErrorGenericError: play.api.libs.json.Writes[GenericError] = {
      (obj: io.flow.error.v0.models.GenericError) => {
        io.flow.error.v0.models.json.jsObjectGenericError(obj)
      }
    }
  }
}
...
package io.flow.error.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/error/latest/play_2_8_client"
    val Version = "0.18.69"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private val logger = play.api.Logger("io.flow.error.v0.Client")
