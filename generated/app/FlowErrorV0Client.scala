 ...
 * apibuilder 0.14.96 app.apibuilder.io/flow/error/latest/play_2_8_client
 */
...
package io.flow.error.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.96 app.apibuilder.io/flow/error/latest/play_2_8_client"
    val Version = "0.8.80"
    val VersionMajor = 0
