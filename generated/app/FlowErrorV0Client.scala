 ...
 * apibuilder 0.14.89 app.apibuilder.io/flow/error/latest/play_2_6_client
 */
...
package io.flow.error.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.89 app.apibuilder.io/flow/error/latest/play_2_6_client"
    val Version = "0.7.58"
    val VersionMajor = 0
