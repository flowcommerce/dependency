 ...
 * apibuilder 0.15.33 app.apibuilder.io/flow/error/latest/play_2_8_client
 */
...
package io.flow.error.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.33 app.apibuilder.io/flow/error/latest/play_2_8_client"
    val Version = "0.10.67"
    val VersionMajor = 0
