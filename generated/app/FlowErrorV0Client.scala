 ...
 * apibuilder 0.13.0 app.apibuilder.io/flow/error/0.4.50/play_2_6_client
 */
...
package io.flow.error.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.13.0 app.apibuilder.io/flow/error/0.4.50/play_2_6_client"
    val Version = "0.4.50"
    val VersionMajor = 0
