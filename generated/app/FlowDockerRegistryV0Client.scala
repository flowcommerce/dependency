 ...
 * apibuilder 0.15.11 app.apibuilder.io/flow/docker-registry/latest/play_2_8_client
 */
...
package io.flow.docker.registry.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.11 app.apibuilder.io/flow/docker-registry/latest/play_2_8_client"
    val Version = "0.2.19"
    val VersionMajor = 0
