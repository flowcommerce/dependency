 ...
 * User agent: apibuilder app.apibuilder.io/flow/docker-registry/latest/play_2_8_client
 */
...
package io.flow.docker.registry.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsDockerRegistryBuild: play.api.libs.json.Reads[io.flow.docker.registry.v0.models.Build] = {
      (__ \ "repo_web_url").read[String].map { x => Build(repoWebUrl = x) }
    }
    ...
    implicit def jsonWritesDockerRegistryBuild: play.api.libs.json.Writes[Build] = {
      (obj: io.flow.docker.registry.v0.models.Build) => {
        io.flow.docker.registry.v0.models.json.jsObjectBuild(obj)
      }
    }

    implicit def jsonReadsDockerRegistryBuildForm: play.api.libs.json.Reads[io.flow.docker.registry.v0.models.BuildForm] = {
      for {
    ...
    implicit def jsonWritesDockerRegistryBuildForm: play.api.libs.json.Writes[BuildForm] = {
      (obj: io.flow.docker.registry.v0.models.BuildForm) => {
        io.flow.docker.registry.v0.models.json.jsObjectBuildForm(obj)
      }
    }

    implicit def jsonReadsDockerRegistryBuildTag: play.api.libs.json.Reads[io.flow.docker.registry.v0.models.BuildTag] = {
      for {
    ...
    implicit def jsonWritesDockerRegistryBuildTag: play.api.libs.json.Writes[BuildTag] = {
      (obj: io.flow.docker.registry.v0.models.BuildTag) => {
        io.flow.docker.registry.v0.models.json.jsObjectBuildTag(obj)
      }
    }

    implicit def jsonReadsDockerRegistryDeploykey: play.api.libs.json.Reads[io.flow.docker.registry.v0.models.Deploykey] = {
      for {
    ...
    implicit def jsonWritesDockerRegistryDeploykey: play.api.libs.json.Writes[Deploykey] = {
      (obj: io.flow.docker.registry.v0.models.Deploykey) => {
        io.flow.docker.registry.v0.models.json.jsObjectDeploykey(obj)
      }
    }

    implicit def jsonReadsDockerRegistryDockerRepository: play.api.libs.json.Reads[io.flow.docker.registry.v0.models.DockerRepository] = {
      (__ \ "name").read[String].map { x => DockerRepository(name = x) }
    }
    ...
    implicit def jsonWritesDockerRegistryDockerRepository: play.api.libs.json.Writes[DockerRepository] = {
      (obj: io.flow.docker.registry.v0.models.DockerRepository) => {
        io.flow.docker.registry.v0.models.json.jsObjectDockerRepository(obj)
      }
    }

    implicit def jsonReadsDockerRegistryTag: play.api.libs.json.Reads[io.flow.docker.registry.v0.models.Tag] = {
      for {
    ...
    implicit def jsonWritesDockerRegistryTag: play.api.libs.json.Writes[Tag] = {
      (obj: io.flow.docker.registry.v0.models.Tag) => {
        io.flow.docker.registry.v0.models.json.jsObjectTag(obj)
      }
    }

    implicit def jsonReadsDockerRegistryV2Tag: play.api.libs.json.Reads[io.flow.docker.registry.v0.models.V2Tag] = {
      (__ \ "results").read[Seq[io.flow.docker.registry.v0.models.V2TagDetails]].map { x => V2Tag(results = x) }
    }
    ...
    implicit def jsonWritesDockerRegistryV2Tag: play.api.libs.json.Writes[V2Tag] = {
      (obj: io.flow.docker.registry.v0.models.V2Tag) => {
        io.flow.docker.registry.v0.models.json.jsObjectV2Tag(obj)
      }
    }

    implicit def jsonReadsDockerRegistryV2TagDetails: play.api.libs.json.Reads[io.flow.docker.registry.v0.models.V2TagDetails] = {
      (__ \ "name").read[String].map { x => V2TagDetails(name = x) }
    }
    ...
    implicit def jsonWritesDockerRegistryV2TagDetails: play.api.libs.json.Writes[V2TagDetails] = {
      (obj: io.flow.docker.registry.v0.models.V2TagDetails) => {
        io.flow.docker.registry.v0.models.json.jsObjectV2TagDetails(obj)
      }
    }
  }
}
...
package io.flow.docker.registry.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/docker-registry/latest/play_2_8_client"
    val Version = "0.3.46"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private val logger = play.api.Logger("io.flow.docker.registry.v0.Client")
