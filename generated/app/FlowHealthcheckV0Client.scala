 ...
 * User agent: apibuilder app.apibuilder.io/flow/healthcheck/latest/play_2_8_client
 */
...
package io.flow.healthcheck.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsHealthcheckHealthcheck: play.api.libs.json.Reads[io.flow.healthcheck.v0.models.Healthcheck] = {
    ...
    implicit def jsonWritesHealthcheckHealthcheck: play.api.libs.json.Writes[Healthcheck] = {
      (obj: io.flow.healthcheck.v0.models.Healthcheck) => {
        io.flow.healthcheck.v0.models.json.jsObjectHealthcheck(obj)
      }
    }
  }
}
...
package io.flow.healthcheck.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/healthcheck/latest/play_2_8_client"
    val Version = "0.18.69"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private val logger = play.api.Logger("io.flow.healthcheck.v0.Client")
