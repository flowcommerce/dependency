 ...
 * apibuilder 0.14.75 app.apibuilder.io/flow/healthcheck/0.7.58/play_2_6_client
 */
...
package io.flow.healthcheck.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.75 app.apibuilder.io/flow/healthcheck/0.7.58/play_2_6_client"
    val Version = "0.7.58"
    val VersionMajor = 0
