 ...
 * apibuilder 0.14.3 app.apibuilder.io/flow/healthcheck/0.4.84/play_2_6_client
 */
...
package io.flow.healthcheck.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/flow/healthcheck/0.4.84/play_2_6_client"
    val Version = "0.4.84"
    val VersionMajor = 0
