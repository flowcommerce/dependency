 ...
 * apibuilder 0.15.8 app.apibuilder.io/flow/healthcheck/latest/play_2_8_client
 */
...
package io.flow.healthcheck.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.8 app.apibuilder.io/flow/healthcheck/latest/play_2_8_client"
    val Version = "0.9.33"
    val VersionMajor = 0
