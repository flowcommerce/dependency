 ...
 * User agent: apibuilder app.apibuilder.io/flow/github-oauth/latest/play_2_8_client
 */
...
package io.flow.github.oauth.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsGithubOauthTokenType: play.api.libs.json.Reads[io.flow.github.oauth.v0.models.TokenType] = new play.api.libs.json.Reads[io.flow.github.oauth.v0.models.TokenType] {
    ...
    implicit def jsonWritesGithubOauthTokenType: play.api.libs.json.Writes[TokenType] = {
      (obj: io.flow.github.oauth.v0.models.TokenType) => {
        io.flow.github.oauth.v0.models.json.jsonWritesGithubOauthTokenType(obj)
      }
    }

    implicit def jsonReadsGithubOauthAccessToken: play.api.libs.json.Reads[io.flow.github.oauth.v0.models.AccessToken] = {
      for {
    ...
    implicit def jsonWritesGithubOauthAccessToken: play.api.libs.json.Writes[AccessToken] = {
      (obj: io.flow.github.oauth.v0.models.AccessToken) => {
        io.flow.github.oauth.v0.models.json.jsObjectAccessToken(obj)
      }
    }

    implicit def jsonReadsGithubOauthAccessTokenForm: play.api.libs.json.Reads[io.flow.github.oauth.v0.models.AccessTokenForm] = {
      for {
    ...
    implicit def jsonWritesGithubOauthAccessTokenForm: play.api.libs.json.Writes[AccessTokenForm] = {
      (obj: io.flow.github.oauth.v0.models.AccessTokenForm) => {
        io.flow.github.oauth.v0.models.json.jsObjectAccessTokenForm(obj)
      }
    }
  }
}
...
package io.flow.github.oauth.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/github-oauth/latest/play_2_8_client"
    val Version = "0.3.46"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private val logger = play.api.Logger("io.flow.github.oauth.v0.Client")
